...
var res = await sdk.Documents.DownloadFileAsync(req);
...
DocumentsListFilesResponse? res = await sdk.Documents.ListFilesAsync(req);
...
var res = await sdk.Documents.GetFileAsync(req);
...
DocumentsListFoldersResponse? res = await sdk.Documents.ListFoldersAsync(req);
...
var res = await sdk.Documents.GetFolderAsync(req);
...
DocumentsListDrivesResponse? res = await sdk.Documents.ListDrivesAsync(req);
...
var res = await sdk.Documents.GetDriveAsync(req);
