...
IamListUsersResponse? res = await sdk.Iam.ListUsersAsync(req);
...
var res = await sdk.Iam.GetUserAsync(req);
...
var res = await sdk.Iam.UpdateUserAsync(
    xAccountId: "<id>",
    id: "<id>",
...
IamListGroupsResponse? res = await sdk.Iam.ListGroupsAsync(req);
...
var res = await sdk.Iam.GetPolicyAsync(req);
