...
CrmListContactsResponse? res = await sdk.Crm.ListContactsAsync(req);
...
var res = await sdk.Crm.CreateContactAsync(
    xAccountId: "<id>",
...
| Parameter                                                             | Type                                                                  | Required                                                              | Description                                                           |
| --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `request`                                                             | [CrmGetContactRequest](../../Models/Requests/CrmGetContactRequest.md) | :heavy_check_mark:                                                    | The request object to use for the request.                            |

### Response

**[CrmGetContactResponse](../../Models/Requests/CrmGetContactResponse.md)**
...
var res = await sdk.Crm.UpdateContactAsync(
    xAccountId: "<id>",
    id: "<id>",
    crmCreateContactRequestDto: new CrmCreateContactRequestDto() {
        FirstName = "Steve",
...
**[CrmUpdateContactResponse](../../Models/Requests/CrmUpdateContactResponse.md)**
...
| Parameter                                                                 | Type                                                                      | Required                                                                  | Description                                                               |
| ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `request`                                                                 | [CrmListAccountsRequest](../../Models/Requests/CrmListAccountsRequest.md) | :heavy_check_mark:                                                        | The request object to use for the request.                                |

### Response

**[CrmListAccountsResponse](../../Models/Requests/CrmListAccountsResponse.md)**
...
| Parameter                                                             | Type                                                                  | Required                                                              | Description                                                           |
| --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `request`                                                             | [CrmGetAccountRequest](../../Models/Requests/CrmGetAccountRequest.md) | :heavy_check_mark:                                                    | The request object to use for the request.                            |

### Response

**[CrmGetAccountResponse](../../Models/Requests/CrmGetAccountResponse.md)**
...
CrmListListsResponse? res = await sdk.Crm.ListListsAsync(req);
...
var res = await sdk.Crm.GetListAsync(req);
...
CrmListContactCustomFieldDefinitionsRequest req = new CrmListContactCustomFieldDefinitionsRequest() {
    XAccountId = "<id>",
...
CrmListContactCustomFieldDefinitionsResponse? res = await sdk.Crm.ListContactCustomFieldDefinitionsAsync(req);
...
| Parameter                                                                                                           | Type                                                                                                                | Required                                                                                                            | Description                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                           | [CrmListContactCustomFieldDefinitionsRequest](../../Models/Requests/CrmListContactCustomFieldDefinitionsRequest.md) | :heavy_check_mark:                                                                                                  | The request object to use for the request.                                                                          |

### Response

**[CrmListContactCustomFieldDefinitionsResponse](../../Models/Requests/CrmListContactCustomFieldDefinitionsResponse.md)**
...
CrmGetContactCustomFieldDefinitionRequest req = new CrmGetContactCustomFieldDefinitionRequest() {
    XAccountId = "<id>",
    Id = "<id>",
    Fields = "id,remote_id,name,description,type,options",
...
var res = await sdk.Crm.GetContactCustomFieldDefinitionAsync(req);
...
| Parameter                                                                                                       | Type                                                                                                            | Required                                                                                                        | Description                                                                                                     |
| --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                       | [CrmGetContactCustomFieldDefinitionRequest](../../Models/Requests/CrmGetContactCustomFieldDefinitionRequest.md) | :heavy_check_mark:                                                                                              | The request object to use for the request.                                                                      |

### Response

**[CrmGetContactCustomFieldDefinitionResponse](../../Models/Requests/CrmGetContactCustomFieldDefinitionResponse.md)**
