    ...
    public class AtsLocations: IAtsLocations
    {
        ...
        public async Task<AtsListLocationsResponse> ListAsync(AtsListLocationsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<ATSLocationsPaginated>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<AtsGetLocationResponse> GetAsync(AtsGetLocationRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<ATSLocationResult>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
