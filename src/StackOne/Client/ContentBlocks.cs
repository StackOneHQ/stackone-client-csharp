...
namespace StackOne.Client
{
    ...
    public interface IContentBlocks
    {
        ...
        /// </summary>
        Task<MarketingUpdateContentBlockResponse> UpdateAsync(string xAccountId, string id, MarketingCreateContentBlocksRequestDto marketingCreateContentBlocksRequestDto, RetryConfig? retryConfig = null);
    }
    ...
    public class ContentBlocks: IContentBlocks
    {
        ...
        public async Task<MarketingUpdateContentBlockResponse> UpdateAsync(string xAccountId, string id, MarketingCreateContentBlocksRequestDto marketingCreateContentBlocksRequestDto, RetryConfig? retryConfig = null)
        {
