...
namespace StackOne.Client.Models.Components
{
    ...
    public class AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType
    {
        ...
        public static implicit operator String(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType v) { return v.Value; }
        public static AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType FromString(string v) {
            switch(v) {
                case "str": return Str;
                case "number": return Number;
                case "boolean": return Boolean;
                case "AtsCreateCandidatesAssessmentsRequestDto_source_value": return AtsCreateCandidatesAssessmentsRequestDtoSourceValue;
                case "arrayOfAny": return ArrayOfAny;
                case "null": return Null;
                default: throw new ArgumentException("Invalid value for AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType");
            }
        }
        public override bool Equals(object? obj)
        {
            ...
            return Value.Equals(((AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType)obj).Value);
        }
    ...
    public class AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion {
        ...
        [SpeakeasyMetadata("form:explode=true")]
        public AtsCreateCandidatesAssessmentsRequestDtoSourceValue? AtsCreateCandidatesAssessmentsRequestDtoSourceValue { get; set; }
        ...
        public class AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionConverter : JsonConverter
        {

            public override bool CanConvert(System.Type objectType) => objectType == typeof(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion);
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                try
                {
                    return new AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType.AtsCreateCandidatesAssessmentsRequestDtoSourceValue)
                    {
                        AtsCreateCandidatesAssessmentsRequestDtoSourceValue = ResponseBodyDeserializer.DeserializeUndiscriminatedUnionMember<AtsCreateCandidatesAssessmentsRequestDtoSourceValue>(json)
                    };
                }
                catch (ResponseBodyDeserializer.MissingMemberException)
                {
                    fallbackCandidates.Add((typeof(AtsCreateCandidatesAssessmentsRequestDtoSourceValue), new AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType.AtsCreateCandidatesAssessmentsRequestDtoSourceValue), "AtsCreateCandidatesAssessmentsRequestDtoSourceValue"));
                }
                ...
                if (json[0] == '"' && json[^1] == '"'){
                    return new AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType.Str)
                    {
                        Str = json[1..^1]
                    };
                }
                ...
                try
                {
                    ...
                    return new AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType.Number)
                    {
                        Number = converted
                    };
                }
                ...
                try
                {
                    ...
                    return new AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType.Boolean)
                    {
                        Boolean = converted
                    };
                }
                ...
                try
                {
                    return new AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType.ArrayOfAny)
                    {
                ...
                {
                    fallbackCandidates.Add((typeof(List<object>), new AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnion(AtsCreateCandidatesAssessmentsRequestDtoSourceValueUnionType.ArrayOfAny), "ArrayOfAny"));
                }
                catch (ResponseBodyDeserializer.DeserializationException)
                {
                    // try next option
