...
namespace StackOne.Client.Models.Components
{
    ...
    public class HrisUpdateEmployeeRequestDtoEmploymentType
    {
        ...
        /// </summary>
        [JsonProperty("value")]
        public HrisUpdateEmployeeRequestDtoEmploymentTypeValue? Value { get; set; } = null;

        /// <summary>
        /// The source value of the employment type.
        /// </summary>
        [JsonProperty("source_value")]
        public HrisUpdateEmployeeRequestDtoEmploymentTypeSourceValueUnion? SourceValue { get; set; } = null;
    }
}