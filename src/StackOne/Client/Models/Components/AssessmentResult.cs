...
namespace StackOne.Client.Models.Components
{
    ...
    public class AssessmentResult
    {
        ...
        public AssessmentResultCandidate? Candidate { get; set; } = null;

        [JsonProperty("score")]
        public AssessmentResultScore? Score { get; set; } = null;
        ...
        [JsonProperty("result")]
        public AssessmentResultResult? Result { get; set; } = null;
