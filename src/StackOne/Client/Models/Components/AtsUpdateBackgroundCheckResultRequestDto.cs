...
namespace StackOne.Client.Models.Components
{
    ...
    public class AtsUpdateBackgroundCheckResultRequestDto
    {
        ...
        [JsonProperty("result")]
        public AtsUpdateBackgroundCheckResultRequestDtoResult? Result { get; set; } = null;
        ...
        public AtsUpdateBackgroundCheckResultRequestDtoCandidate? Candidate { get; set; } = null;
