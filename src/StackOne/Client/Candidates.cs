...
namespace StackOne.Client
{
    ...
    public interface ICandidates
    {
        ...
        /// Create Candidate
        /// </summary>
        Task<AtsCreateCandidateResponse> CreateAsync(string xAccountId, AtsCreateCandidateRequestDto atsCreateCandidateRequestDto, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get Candidate
        /// </summary>
        Task<AtsGetCandidateResponse> GetAsync(AtsGetCandidateRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Candidates: ICandidates
    {
        ...
        public async Task<AtsCreateCandidateResponse> CreateAsync(string xAccountId, AtsCreateCandidateRequestDto atsCreateCandidateRequestDto, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_create_candidate", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<AtsGetCandidateResponse> GetAsync(AtsGetCandidateRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_candidate", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CandidateResult>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
