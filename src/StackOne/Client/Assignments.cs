...
namespace StackOne.Client
{
    ...
    public class Assignments: IAssignments
    {
        ...
        public async Task<LmsCreateUserAssignmentResponse> CreateAsync(string xAccountId, string id, LmsCreateAssignmentRequestDto lmsCreateAssignmentRequestDto, RetryConfig? retryConfig = null)
        {
