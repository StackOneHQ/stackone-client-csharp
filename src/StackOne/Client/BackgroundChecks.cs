...
namespace StackOne.Client
{
    ...
    public interface IBackgroundChecks
    {

        /// <summary>
        /// Delete Background Check Package
        /// </summary>
        Task<AtsDeleteBackgroundCheckPackageResponse> DeletePackageAsync(string xAccountId, string id, RetryConfig? retryConfig = null);
    }

    public class BackgroundChecks: IBackgroundChecks
    {
        ...
        public BackgroundChecks(SDKConfig config)
        {
            SDKConfiguration = config;
        }

        public async Task<AtsDeleteBackgroundCheckPackageResponse> DeletePackageAsync(string xAccountId, string id, RetryConfig? retryConfig = null)
        {
            var request = new AtsDeleteBackgroundCheckPackageRequest()
            {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_delete_background_check_package", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsDeleteBackgroundCheckPackageResponse()
                    {
