...
namespace StackOne
{
    ...
    /// StackOne: The documentation for the StackOne API
    /// </summary>
    public class StackOneSDK: IStackOneSDK
    {
        ...
        public StackOneSDK(SDKConfig config)
        {
        ...
        public StackOneSDK(StackOne.Models.Components.Security? security = null, Func<StackOne.Models.Components.Security>? securitySource = null, int? serverIndex = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null, RetryConfig? retryConfig = null)
        {
            if (serverIndex != null)
            {
            ...
            Func<StackOne.Models.Components.Security>? _securitySource = null;
        ...
        public class SDKBuilder
        {
            ...
            public SDKBuilder WithSecuritySource(Func<StackOne.Models.Components.Security> securitySource)
            {
                _sdkConfig.SecuritySource = securitySource;
                return this;
            }

            public SDKBuilder WithSecurity(StackOne.Models.Components.Security security)
            {
            ...
            public StackOneSDK Build()
            {
              ...
              return new StackOneSDK(_sdkConfig);
            }
