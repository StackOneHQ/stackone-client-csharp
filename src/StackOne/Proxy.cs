...
namespace StackOne
{
    ...
    public interface IProxy
    {
        ...
        /// Proxy Request
        /// </summary>
        Task<StackoneProxyRequestResponse> PerformAsync(string xAccountId, ProxyRequestBody proxyRequestBody, RetryConfig? retryConfig = null);
    }
    ...
    public class Proxy: IProxy
    {
        ...
        public async Task<StackoneProxyRequestResponse> PerformAsync(string xAccountId, ProxyRequestBody proxyRequestBody, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_proxy_request", new List<string> {  }, SDKConfiguration.SecuritySource);
