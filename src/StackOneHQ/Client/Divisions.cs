...
namespace StackOneHQ.Client
{
    ...
    public interface IDivisions
    {
        ...
        /// Get Division Group
        /// </summary>
        Task<HrisGetDivisionGroupResponse> GetAsync(HrisGetDivisionGroupRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Divisions: IDivisions
    {
        ...
        public async Task<HrisGetDivisionGroupResponse> GetAsync(HrisGetDivisionGroupRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/divisions/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_division_group", new List<string> {  }, SDKConfiguration.SecuritySource);
