...
namespace StackOneHQ.Client
{
    ...
    public interface IDivisions
    {
        ...
        /// Get Division Group.
        /// </summary>
        /// <param name="request">A <see cref="HrisGetDivisionGroupRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisGetDivisionGroupResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisGetDivisionGroupResponse> GetAsync(
            HrisGetDivisionGroupRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class Divisions: IDivisions
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public Divisions(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisGetDivisionGroupResponse> GetAsync(
            HrisGetDivisionGroupRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/divisions/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_division_group", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    HRISDivisionsResult obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<HRISDivisionsResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into HRISDivisionsResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new HrisGetDivisionGroupResponse()
                    {
                    ...
                    response.HRISDivisionsResult = obj;
                    return response;
                }
