...
namespace StackOneHQ.Client
{
    ...
    public interface IDocuments
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="AtsListApplicationDocumentCategoriesRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListApplicationDocumentCategoriesResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListApplicationDocumentCategoriesResponse> ListApplicationCategoriesAsync(
            AtsListApplicationDocumentCategoriesRequest request,
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<DocumentsUploadFileResponse> UploadFileAsync(
            string xAccountId,
    ...
    public class Documents: IDocuments
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListApplicationDocumentCategoriesResponse> ListApplicationCategoriesAsync(
            AtsListApplicationDocumentCategoriesRequest request,
            RetryConfig? retryConfig = null
        )
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<DocumentsUploadFileResponse> UploadFileAsync(
            string xAccountId,
            UnifiedUploadRequestDto unifiedUploadRequestDto,
            string? xStackoneApiSessionToken = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            if (unifiedUploadRequestDto == null) throw new ArgumentNullException(nameof(unifiedUploadRequestDto));
