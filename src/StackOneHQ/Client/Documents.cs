...
namespace StackOneHQ.Client
{
    ...
    public interface IDocuments
    {
        ...
        public IDocumentsDrives Drives { get; }

        /// <summary>
        /// List Application Document Categories
        /// </summary>
        Task<AtsListApplicationDocumentCategoriesResponse> ListApplicationCategoriesAsync(AtsListApplicationDocumentCategoriesRequest request, RetryConfig? retryConfig = null);
    ...
    public class Documents: IDocuments
    {
        ...
        public IDocumentsDrives Drives { get; private set; }
        ...
        public Documents(SDKConfig config)
        {
            ...
            Drives = new DocumentsDrives(SDKConfiguration);
        }

        public async Task<AtsListApplicationDocumentCategoriesResponse> ListApplicationCategoriesAsync(AtsListApplicationDocumentCategoriesRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/documents/application_categories", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_application_document_categories", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListApplicationDocumentCategoriesResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListApplicationDocumentCategoriesRequest
                {
                ...
                return await ListApplicationCategoriesAsync (
                    request: newRequest,
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsListApplicationDocumentCategoriesResponse()
                    {
