...
namespace StackOneHQ.Client
{
    ...
    public class Documents: IDocuments
    {
        ...
        public async Task<AtsListApplicationDocumentCategoriesResponse> ListApplicationCategoriesAsync(AtsListApplicationDocumentCategoriesRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/documents/application_categories", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_application_document_categories", null, SDKConfiguration.SecuritySource);
        ...
        public async Task<DocumentsUploadFileResponse> UploadFileAsync(string xAccountId, UnifiedUploadRequestDto unifiedUploadRequestDto, string? xStackoneApiSessionToken = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "documents_upload_file", null, SDKConfiguration.SecuritySource);
