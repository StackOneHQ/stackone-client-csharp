...
namespace StackOneHQ.Client
{
    ...
    public interface IJobPostings
    {
        ...
        /// Get Job Posting.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetJobPostingRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetJobPostingResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetJobPostingResponse> GetAsync(AtsGetJobPostingRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class JobPostings: IJobPostings
    {
        ...
        public JobPostings(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetJobPostingResponse> GetAsync(
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/job_postings/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_job_posting", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<JobPostingResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into JobPostingResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsGetJobPostingResponse()
                    {
