...
namespace StackOneHQ.Client
{
    ...
    public interface IJobPostings
    {
        ...
        /// Get Job Posting
        /// </summary>
        Task<AtsGetJobPostingResponse> GetAsync(AtsGetJobPostingRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class JobPostings: IJobPostings
    {
        ...
        public async Task<AtsGetJobPostingResponse> GetAsync(AtsGetJobPostingRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/job_postings/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_job_posting", new List<string> {  }, SDKConfiguration.SecuritySource);
