...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployeesSkills
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="HrisListEmployeeSkillsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListEmployeeSkillsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListEmployeeSkillsResponse> ListAsync(
    ...
    public class EmployeesSkills: IEmployeesSkills
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListEmployeeSkillsResponse> ListAsync(
            HrisListEmployeeSkillsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_employee_skills", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<EntitySkillsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into EntitySkillsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
