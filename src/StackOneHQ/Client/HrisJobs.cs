...
namespace StackOneHQ.Client
{
    ...
    public interface IHrisJobs
    {
        ...
        /// List Jobs
        /// </summary>
        Task<HrisListJobsResponse> ListAsync(HrisListJobsRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get Job
        /// </summary>
        Task<HrisGetJobResponse> GetAsync(HrisGetJobRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class HrisJobs: IHrisJobs
    {
        ...
        public async Task<HrisListJobsResponse> ListAsync(HrisListJobsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/jobs", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_jobs", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/jobs/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_job", new List<string> {  }, SDKConfiguration.SecuritySource);
