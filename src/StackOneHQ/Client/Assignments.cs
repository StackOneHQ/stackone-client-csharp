...
namespace StackOneHQ.Client
{
    ...
    public interface IAssignments
    {
        ...
        /// <param name="lmsCreateAssignmentRequestDto">A <see cref="LmsCreateAssignmentRequestDto"/> parameter.</param>
        ...
        /// <returns>An awaitable task that returns a <see cref="LmsCreateUserAssignmentResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="xAccountId"/>, <paramref name="id"/> or <paramref name="lmsCreateAssignmentRequestDto"/> is null.</exception>
        ...
        public  Task<LmsCreateUserAssignmentResponse> CreateAsync(
            string xAccountId,
            string id,
        ...
        /// </remarks>
        /// <param name="request">A <see cref="LmsListAssignmentsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="LmsListAssignmentsResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<LmsListAssignmentsResponse> ListAsync(
        ...
        /// </remarks>
        /// <param name="request">A <see cref="LmsGetAssignmentRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="LmsGetAssignmentResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<LmsGetAssignmentResponse> GetAsync(LmsGetAssignmentRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Assignments: IAssignments
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsCreateUserAssignmentResponse> CreateAsync(
            string xAccountId,
            string id,
            LmsCreateAssignmentRequestDto lmsCreateAssignmentRequestDto,
            string? prefer = null,
        ...
        )
        {
            ...
            if (lmsCreateAssignmentRequestDto == null) throw new ArgumentNullException(nameof(lmsCreateAssignmentRequestDto));
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_create_user_assignment", null, SDKConfiguration.SecuritySource);
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsListAssignmentsResponse> ListAsync(
            LmsListAssignmentsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_list_assignments", null, SDKConfiguration.SecuritySource);
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsGetAssignmentResponse> GetAsync(
        ...
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_get_assignment", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AssignmentResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AssignmentResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
