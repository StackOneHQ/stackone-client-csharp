...
namespace StackOneHQ.Client
{
    ...
    public interface IApplicationCategories
    {
        ...
        /// </summary>
        Task<AtsGetApplicationDocumentCategoryResponse> GetAsync(AtsGetApplicationDocumentCategoryRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class ApplicationCategories: IApplicationCategories
    {
        ...
        public async Task<AtsGetApplicationDocumentCategoryResponse> GetAsync(AtsGetApplicationDocumentCategoryRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/documents/application_categories/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_application_document_category", new List<string> {  }, SDKConfiguration.SecuritySource);
