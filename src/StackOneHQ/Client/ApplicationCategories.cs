...
namespace StackOneHQ.Client
{
    ...
    public interface IApplicationCategories
    {
        /// <summary>
        /// Get Application Document Category.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetApplicationDocumentCategoryRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetApplicationDocumentCategoryResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetApplicationDocumentCategoryResponse> GetAsync(
            AtsGetApplicationDocumentCategoryRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class ApplicationCategories: IApplicationCategories
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public ApplicationCategories(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetApplicationDocumentCategoryResponse> GetAsync(
            AtsGetApplicationDocumentCategoryRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/documents/application_categories/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_application_document_category", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsGetApplicationDocumentCategoryResponse()
                    {
