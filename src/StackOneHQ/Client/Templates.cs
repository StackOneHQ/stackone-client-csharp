...
namespace StackOneHQ.Client
{
    ...
    public interface ITemplates
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="MarketingCreateOmniChannelTemplateResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="xAccountId"/> or <paramref name="marketingCreateTemplateRequestDto"/> is null.</exception>
        ...
        public  Task<MarketingCreateOmniChannelTemplateResponse> CreateOmniChannelAsync(
            string xAccountId,
        ...
        /// <param name="prefer">Set to "heartbeat" to enable keep-alive newline heartbeats during long-running requests. Response includes Preference-Applied: heartbeat header when honored. (RFC 7240).</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="MarketingCreatePushTemplateResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="xAccountId"/> or <paramref name="marketingCreatePushTemplateRequestDto"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="UnauthorizedResponseException">Unauthorized access. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<MarketingCreatePushTemplateResponse> CreatePushAsync(
            string xAccountId,
        ...
        /// Get Push Template.
        /// </summary>
        /// <param name="request">A <see cref="MarketingGetPushTemplateRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="MarketingGetPushTemplateResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<MarketingGetPushTemplateResponse> GetPushAsync(
    ...
    public class Templates: ITemplates
    {
        ...
        /// <see cref="IInApp"/>
        /// </summary>
        public IInApp InApp { get; private set; }
        ...
        public Templates(SDKConfig config)
        {
            ...
            InApp = new InApp(SDKConfiguration);
        ...
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public async  Task<MarketingCreateOmniChannelTemplateResponse> CreateOmniChannelAsync(
            string xAccountId,
            MarketingCreateTemplateRequestDto marketingCreateTemplateRequestDto,
            string? prefer = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "marketing_create_omni_channel_template", null, SDKConfiguration.SecuritySource);
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<MarketingCreatePushTemplateResponse> CreatePushAsync(
            string xAccountId,
            MarketingCreatePushTemplateRequestDto marketingCreatePushTemplateRequestDto,
            string? prefer = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "marketing_create_push_template", null, SDKConfiguration.SecuritySource);
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<MarketingGetPushTemplateResponse> GetPushAsync(
            MarketingGetPushTemplateRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "marketing_get_push_template", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<PushTemplateResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into PushTemplateResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
