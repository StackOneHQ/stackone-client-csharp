...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsDepartments
    {
        /// <summary>
        /// Get Department.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetDepartmentRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetDepartmentResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetDepartmentResponse> GetAsync(AtsGetDepartmentRequest request, RetryConfig? retryConfig = null);
    }

    public class AtsDepartments: IAtsDepartments
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public AtsDepartments(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetDepartmentResponse> GetAsync(
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/departments/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_department", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<DepartmentResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into DepartmentResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsGetDepartmentResponse()
                    {
