...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsDepartments
    {
        ...
        /// Get Department
        /// </summary>
        Task<AtsGetDepartmentResponse> GetAsync(AtsGetDepartmentRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AtsDepartments: IAtsDepartments
    {
        ...
        public async Task<AtsGetDepartmentResponse> GetAsync(AtsGetDepartmentRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/departments/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_department", new List<string> {  }, SDKConfiguration.SecuritySource);
