...
namespace StackOneHQ.Client
{
    ...
    public interface ICrmLists
    {
        ...
        /// Get all Lists
        /// </summary>
        Task<CrmListListsResponse> ListAsync(CrmListListsRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get List
        /// </summary>
        Task<CrmGetListResponse> GetAsync(CrmGetListRequest request, RetryConfig? retryConfig = null);
    }
