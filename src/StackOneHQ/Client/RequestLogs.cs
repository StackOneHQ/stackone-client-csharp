...
namespace StackOneHQ.Client
{
    ...
    public interface IRequestLogs
    {
        ...
        /// List Platform Logs
        /// </summary>
        Task<StackoneListPlatformLogsResponse> ListPlatformLogsAsync(StackoneListPlatformLogsRequest? request = null, RetryConfig? retryConfig = null);
    }
    ...
    public class RequestLogs: IRequestLogs
    {
        ...
        public async Task<StackoneListPlatformLogsResponse> ListPlatformLogsAsync(StackoneListPlatformLogsRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_list_platform_logs", new List<string> {  }, SDKConfiguration.SecuritySource);
