...
namespace StackOneHQ.Client
{
    ...
    public interface ICustomFieldDefinitionsContacts
    {
        /// <summary>
        /// List Contact Custom Field Definitions.
        /// </summary>
        /// <param name="request">A <see cref="CrmListContactCustomFieldDefinitionsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="CrmListContactCustomFieldDefinitionsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<CrmListContactCustomFieldDefinitionsResponse> ListAsync(
        ...
        /// </summary>
        /// <param name="request">A <see cref="CrmGetContactCustomFieldDefinitionRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="CrmGetContactCustomFieldDefinitionResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<CrmGetContactCustomFieldDefinitionResponse> GetAsync(
    ...
    public class CustomFieldDefinitionsContacts: ICustomFieldDefinitionsContacts
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CrmListContactCustomFieldDefinitionsResponse> ListAsync(
            CrmListContactCustomFieldDefinitionsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm_list_contact_custom_field_definitions", null, SDKConfiguration.SecuritySource);
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CrmGetContactCustomFieldDefinitionResponse> GetAsync(
            CrmGetContactCustomFieldDefinitionRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "crm_get_contact_custom_field_definition", null, SDKConfiguration.SecuritySource);
