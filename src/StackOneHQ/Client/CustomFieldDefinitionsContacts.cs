...
namespace StackOneHQ.Client
{
    ...
    public interface ICustomFieldDefinitionsContacts
    {
        ...
        /// </summary>
        Task<CrmListContactCustomFieldDefinitionsResponse> ListAsync(CrmListContactCustomFieldDefinitionsRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get Contact Custom Field Definition
        /// </summary>
        Task<CrmGetContactCustomFieldDefinitionResponse> GetAsync(CrmGetContactCustomFieldDefinitionRequest request, RetryConfig? retryConfig = null);
    }
