...
namespace StackOneHQ.Client
{
    ...
    public interface IBackgroundChecks
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="AtsDeleteBackgroundCheckPackageResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsDeleteBackgroundCheckPackageResponse> DeletePackageAsync(
            string xAccountId,
            string id,
            string? prefer = null,
    ...
    public class BackgroundChecks: IBackgroundChecks
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsDeleteBackgroundCheckPackageResponse> DeletePackageAsync(
            string xAccountId,
            string id,
            string? prefer = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_delete_background_check_package", null, SDKConfiguration.SecuritySource);
