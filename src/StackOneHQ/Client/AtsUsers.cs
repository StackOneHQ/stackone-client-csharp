...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsUsers
    {
        /// <summary>
        /// List Users.
        /// </summary>
        /// <param name="request">A <see cref="AtsListUsersRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListUsersResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListUsersResponse> ListAsync(AtsListUsersRequest request, RetryConfig? retryConfig = null);
    }

    public class AtsUsers: IAtsUsers
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public AtsUsers(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListUsersResponse> ListAsync(AtsListUsersRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/users", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_users", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListUsersResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListUsersRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsListUsersResponse()
                    {
