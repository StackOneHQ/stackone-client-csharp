...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsUsers
    {
        ...
        /// List Users
        /// </summary>
        Task<AtsListUsersResponse> ListAsync(AtsListUsersRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AtsUsers: IAtsUsers
    {
        ...
        public async Task<AtsListUsersResponse> ListAsync(AtsListUsersRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/users", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_users", new List<string> {  }, SDKConfiguration.SecuritySource);
