...
namespace StackOneHQ.Client
{
    ...
    public interface IConnectors
    {
        ...
        /// </summary>
        /// <param name="include">The comma separated list of data that will be included in the response.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="StackoneListConnectorsMetaResponse"/> response envelope when completed.</returns>
        ...
        public  Task<StackoneListConnectorsMetaResponse> ListMetaAsync(
            string? include = null,
        ...
        /// </summary>
        /// <param name="provider">Description not available.</param>
        /// <param name="include">The comma separated list of data that will be included in the response.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="StackoneGetConnectorMetaResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="provider"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="UnauthorizedResponseException">Unauthorized access. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<StackoneGetConnectorMetaResponse> GetMetaAsync(
            string provider,
            string? include = null,
            RetryConfig? retryConfig = null
        );
    ...
    public class Connectors: IConnectors
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<StackoneListConnectorsMetaResponse> ListMetaAsync(
            string? include = null,
            RetryConfig? retryConfig = null
        )
        {
            var request = new StackoneListConnectorsMetaRequest()
            {
                Include = include,
            };
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_list_connectors_meta", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    List<ConnectorsMeta> obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<List<ConnectorsMeta>>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into List<ConnectorsMeta>.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new StackoneListConnectorsMetaResponse()
                    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<StackoneGetConnectorMetaResponse> GetMetaAsync(
            string provider,
            string? include = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var request = new StackoneGetConnectorMetaRequest()
            {
                Provider = provider,
                Include = include,
            };
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_get_connector_meta", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ConnectorsMeta>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ConnectorsMeta.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new StackoneGetConnectorMetaResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
