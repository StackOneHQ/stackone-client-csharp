...
namespace StackOneHQ.Client
{
    ...
    public interface IWorkEligibility
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="HrisUpdateEmployeeWorkEligibilityRequestRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisUpdateEmployeeWorkEligibilityRequestResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisUpdateEmployeeWorkEligibilityRequestResponse> UpdateRequestAsync(
    ...
    public class WorkEligibility: IWorkEligibility
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisUpdateEmployeeWorkEligibilityRequestResponse> UpdateRequestAsync(
            HrisUpdateEmployeeWorkEligibilityRequestRequest request,
            RetryConfig? retryConfig = null
        )
        {
