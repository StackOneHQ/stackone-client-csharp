...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployeesDocuments
    {
        ...
        /// </summary>
        Task<HrisDownloadEmployeeDocumentResponse> DownloadAsync(HrisDownloadEmployeeDocumentRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class EmployeesDocuments: IEmployeesDocuments
    {
        ...
        public async Task<HrisDownloadEmployeeDocumentResponse> DownloadAsync(HrisDownloadEmployeeDocumentRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/employees/{id}/documents/{subResourceId}/download", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_download_employee_document", new List<string> {  }, SDKConfiguration.SecuritySource);
