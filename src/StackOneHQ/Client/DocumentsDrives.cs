...
namespace StackOneHQ.Client
{
    ...
    public interface IDocumentsDrives
    {
        ...
        /// List Drives
        /// </summary>
        Task<DocumentsListDrivesResponse> ListAsync(DocumentsListDrivesRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class DocumentsDrives: IDocumentsDrives
    {
        ...
        public async Task<DocumentsListDrivesResponse> ListAsync(DocumentsListDrivesRequest request, RetryConfig? retryConfig = null)
        {
