...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsInterviews
    {
        /// <summary>
        /// List Interviews.
        /// </summary>
        /// <param name="request">A <see cref="AtsListInterviewsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListInterviewsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListInterviewsResponse> ListAsync(
            AtsListInterviewsRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class AtsInterviews: IAtsInterviews
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public AtsInterviews(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListInterviewsResponse> ListAsync(
            AtsListInterviewsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/interviews", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_interviews", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListInterviewsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListInterviewsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<InterviewsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into InterviewsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsListInterviewsResponse()
                    {
                    ...
                    response.InterviewsPaginated = obj;
                    return response;
                }
