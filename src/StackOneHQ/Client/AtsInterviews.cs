...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsInterviews
    {
        ...
        /// List Interviews
        /// </summary>
        Task<AtsListInterviewsResponse> ListAsync(AtsListInterviewsRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AtsInterviews: IAtsInterviews
    {
        ...
        public async Task<AtsListInterviewsResponse> ListAsync(AtsListInterviewsRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/interviews", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_interviews", new List<string> {  }, SDKConfiguration.SecuritySource);
