...
namespace StackOneHQ.Client
{
    ...
    public interface ICourses
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="LmsListCoursesRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="LmsListCoursesResponse"/> response envelope when completed.</returns>
        ...
        public  Task<LmsListCoursesResponse> ListAsync(LmsListCoursesRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Courses: ICourses
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsListCoursesResponse> ListAsync(
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/lms/courses", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_list_courses", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CoursePaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CoursePaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
