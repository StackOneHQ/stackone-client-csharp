...
namespace StackOneHQ.Client
{
    ...
    public interface IComments
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="TicketingGetCommentRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="TicketingGetCommentResponse"/> response envelope when completed.</returns>
        ...
        public  Task<TicketingGetCommentResponse> GetAsync(
            TicketingGetCommentRequest request,
    ...
    public class Comments: IComments
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<TicketingGetCommentResponse> GetAsync(
            TicketingGetCommentRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ticketing/tickets/{id}/comments/{subResourceId}", request, null);
