...
namespace StackOneHQ.Client
{
    ...
    public interface ICompanies
    {
        ...
        /// Get Company Group.
        /// </summary>
        /// <param name="request">A <see cref="HrisGetCompanyGroupRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisGetCompanyGroupResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisGetCompanyGroupResponse> GetAsync(
            HrisGetCompanyGroupRequest request,
    ...
    public class Companies: ICompanies
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisGetCompanyGroupResponse> GetAsync(
            HrisGetCompanyGroupRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/companies/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_company_group", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisGetCompanyGroupResponse()
                    {
