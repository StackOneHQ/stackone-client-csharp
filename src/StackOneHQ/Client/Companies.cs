...
namespace StackOneHQ.Client
{
    ...
    public interface ICompanies
    {
        ...
        /// Get Company Group
        /// </summary>
        Task<HrisGetCompanyGroupResponse> GetAsync(HrisGetCompanyGroupRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Companies: ICompanies
    {
        ...
        public async Task<HrisGetCompanyGroupResponse> GetAsync(HrisGetCompanyGroupRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/companies/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_company_group", new List<string> {  }, SDKConfiguration.SecuritySource);
