...
namespace StackOneHQ.Client
{
    ...
    public interface IAssessments
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="AtsListAssessmentsPackagesRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListAssessmentsPackagesResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListAssessmentsPackagesResponse> PackagesListAsync(
    ...
    public class Assessments: IAssessments
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListAssessmentsPackagesResponse> PackagesListAsync(
            AtsListAssessmentsPackagesRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/assessments/packages", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_assessments_packages", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AssessmentPackagePaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AssessmentPackagePaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
