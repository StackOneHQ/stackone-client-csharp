...
namespace StackOneHQ.Client
{
    ...
    {
        public IAssessmentsPackages Packages { get; }

        /// <summary>
        /// List Assessments Packages
        /// </summary>
        Task<AtsListAssessmentsPackagesResponse> PackagesListAsync(AtsListAssessmentsPackagesRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get Assessments Results
        /// </summary>
        Task<AtsGetAssessmentsResultResponse> GetResultsAsync(AtsGetAssessmentsResultRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Assessments: IAssessments
    {
        ...
        public IAssessmentsPackages Packages { get; private set; }

        public Assessments(SDKConfig config)
        {
            SDKConfiguration = config;
            Packages = new AssessmentsPackages(SDKConfiguration);
        }

        public async Task<AtsListAssessmentsPackagesResponse> PackagesListAsync(AtsListAssessmentsPackagesRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/assessments/packages", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_assessments_packages", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListAssessmentsPackagesResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListAssessmentsPackagesRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AssessmentPackagePaginated>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new AtsListAssessmentsPackagesResponse()
                    {
                    ...
                    response.AssessmentPackagePaginated = obj;
                    return response;
                }
        ...
        public async Task<AtsGetAssessmentsResultResponse> GetResultsAsync(AtsGetAssessmentsResultRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/assessments/orders/{id}/results", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_assessments_result", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AssessmentResultsResult>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new AtsGetAssessmentsResultResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.AssessmentResultsResult = obj;
                    return response;
                }
