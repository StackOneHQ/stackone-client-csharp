...
namespace StackOneHQ.Client
{
    ...
    public interface ICandidatesCustomFieldDefinitions
    {
        /// <summary>
        /// Get Candidate Custom Field Definition.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetCandidateCustomFieldDefinitionRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetCandidateCustomFieldDefinitionResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetCandidateCustomFieldDefinitionResponse> GetAsync(
            AtsGetCandidateCustomFieldDefinitionRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class CandidatesCustomFieldDefinitions: ICandidatesCustomFieldDefinitions
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public CandidatesCustomFieldDefinitions(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetCandidateCustomFieldDefinitionResponse> GetAsync(
            AtsGetCandidateCustomFieldDefinitionRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/custom_field_definitions/candidates/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_candidate_custom_field_definition", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsGetCandidateCustomFieldDefinitionResponse()
                    {
