...
namespace StackOneHQ.Client
{
    ...
    public interface ICandidatesCustomFieldDefinitions
    {
        ...
        /// </summary>
        Task<AtsGetCandidateCustomFieldDefinitionResponse> GetAsync(AtsGetCandidateCustomFieldDefinitionRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class CandidatesCustomFieldDefinitions: ICandidatesCustomFieldDefinitions
    {
        ...
        public async Task<AtsGetCandidateCustomFieldDefinitionResponse> GetAsync(AtsGetCandidateCustomFieldDefinitionRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/custom_field_definitions/candidates/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_candidate_custom_field_definition", new List<string> {  }, SDKConfiguration.SecuritySource);
