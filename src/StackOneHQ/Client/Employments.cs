...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployments
    {
        ...
        /// List Employments
        /// </summary>
        Task<HrisListEmploymentsResponse> ListAsync(HrisListEmploymentsRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Employments: IEmployments
    {
        ...
        public async Task<HrisListEmploymentsResponse> ListAsync(HrisListEmploymentsRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/employments", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_employments", new List<string> {  }, SDKConfiguration.SecuritySource);
