...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployments
    {
        /// <summary>
        /// List Employments.
        /// </summary>
        /// <param name="request">A <see cref="HrisListEmploymentsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListEmploymentsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListEmploymentsResponse> ListAsync(
    ...
    public class Employments: IEmployments
    {
        ...
        public Employments(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListEmploymentsResponse> ListAsync(
            HrisListEmploymentsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/employments", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_employments", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<HrisListEmploymentsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new HrisListEmploymentsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisListEmploymentsResponse()
                    {
