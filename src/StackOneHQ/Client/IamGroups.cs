...
namespace StackOneHQ.Client
{
    ...
    public interface IIamGroups
    {
        /// <summary>
        /// List Groups.
        /// </summary>
        /// <param name="request">A <see cref="IamListGroupsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="IamListGroupsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<IamListGroupsResponse> ListAsync(IamListGroupsRequest request, RetryConfig? retryConfig = null);
    }

    public class IamGroups: IIamGroups
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public IamGroups(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<IamListGroupsResponse> ListAsync(
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/iam/groups", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "iam_list_groups", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<IamGroupsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into IamGroupsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
