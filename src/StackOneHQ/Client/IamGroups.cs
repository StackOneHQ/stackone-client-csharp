...
namespace StackOneHQ.Client
{
    ...
    public interface IIamGroups
    {
        ...
        /// List Groups
        /// </summary>
        Task<IamListGroupsResponse> ListAsync(IamListGroupsRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class IamGroups: IIamGroups
    {
        ...
        public async Task<IamListGroupsResponse> ListAsync(IamListGroupsRequest request, RetryConfig? retryConfig = null)
        {
