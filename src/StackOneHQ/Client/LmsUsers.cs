...
namespace StackOneHQ.Client
{
    ...
    public interface ILmsUsers
    {
        ...
        /// </remarks>
        /// </summary>
        Task<LmsListUserCompletionsResponse> ListCompletionsAsync(LmsListUserCompletionsRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class LmsUsers: ILmsUsers
    {
        ...
        public async Task<LmsListUserCompletionsResponse> ListCompletionsAsync(LmsListUserCompletionsRequest request, RetryConfig? retryConfig = null)
        {
