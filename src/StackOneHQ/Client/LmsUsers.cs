...
namespace StackOneHQ.Client
{
    ...
    public interface ILmsUsers
    {
        /// <summary>
        /// List User Completions.
        /// </summary>
        /// <remarks>
        /// Retrieve a list of completed learning records for a user. <br/>
        /// <br/>
        /// These are the records of a user completing learning objects.
        /// </remarks>
        /// <param name="request">A <see cref="LmsListUserCompletionsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="LmsListUserCompletionsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<LmsListUserCompletionsResponse> ListCompletionsAsync(
            LmsListUserCompletionsRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class LmsUsers: ILmsUsers
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public LmsUsers(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsListUserCompletionsResponse> ListCompletionsAsync(
            LmsListUserCompletionsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_list_user_completions", null, SDKConfiguration.SecuritySource);
