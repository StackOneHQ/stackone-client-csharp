...
namespace StackOneHQ.Client
{
    ...
    public interface IDrives
    {
        ...
        /// Get Drive
        /// </summary>
        Task<DocumentsGetDriveResponse> GetAsync(DocumentsGetDriveRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Drives: IDrives
    {
        ...
        public async Task<DocumentsGetDriveResponse> GetAsync(DocumentsGetDriveRequest request, RetryConfig? retryConfig = null)
        {
