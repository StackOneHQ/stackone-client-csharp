...
namespace StackOneHQ.Client
{
    ...
    public interface IUsersAssignments
    {
        ...
        /// </remarks>
        /// </summary>
        Task<LmsGetUserAssignmentResponse> GetAsync(LmsGetUserAssignmentRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class UsersAssignments: IUsersAssignments
    {
        ...
        public async Task<LmsGetUserAssignmentResponse> GetAsync(LmsGetUserAssignmentRequest request, RetryConfig? retryConfig = null)
        {
