...
namespace StackOneHQ.Client
{
    ...
    public interface IUsersAssignments
    {
        /// <summary>
        /// Get User Assignment.
        /// </summary>
        /// <remarks>
        /// Retrieve an assignment type learning record for a user by its identifier. <br/>
        /// <br/>
        /// This is the record linking a user to a learning object. <br/>
        /// <br/>
        /// It can be pending, in progress, or completed.
        /// </remarks>
        /// <param name="request">A <see cref="LmsGetUserAssignmentRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="LmsGetUserAssignmentResponse"/> response envelope when completed.</returns>
        ...
        public  Task<LmsGetUserAssignmentResponse> GetAsync(
            LmsGetUserAssignmentRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class UsersAssignments: IUsersAssignments
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public UsersAssignments(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsGetUserAssignmentResponse> GetAsync(
            LmsGetUserAssignmentRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/lms/users/{id}/assignments/{subResourceId}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_get_user_assignment", null, SDKConfiguration.SecuritySource);
