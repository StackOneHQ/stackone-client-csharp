...
namespace StackOneHQ.Client
{
    ...
    public interface IContent
    {
        ...
        /// <param name="lmsUpsertContentRequestDto">A <see cref="LmsUpsertContentRequestDto"/> parameter.</param>
        ...
        /// <returns>An awaitable task that returns a <see cref="LmsUpsertContentResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="xAccountId"/> or <paramref name="lmsUpsertContentRequestDto"/> is null.</exception>
        ...
        public  Task<LmsUpsertContentResponse> UpsertAsync(
            string xAccountId,
        ...
        /// </remarks>
        /// <param name="request">A <see cref="LmsGetContentRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="LmsGetContentResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<LmsGetContentResponse> GetAsync(LmsGetContentRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Content: IContent
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsUpsertContentResponse> UpsertAsync(
            string xAccountId,
            LmsUpsertContentRequestDto lmsUpsertContentRequestDto,
            string? prefer = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            if (lmsUpsertContentRequestDto == null) throw new ArgumentNullException(nameof(lmsUpsertContentRequestDto));
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_upsert_content", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<UpsertResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into UpsertResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsGetContentResponse> GetAsync(LmsGetContentRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/lms/content/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_get_content", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ContentResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ContentResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
