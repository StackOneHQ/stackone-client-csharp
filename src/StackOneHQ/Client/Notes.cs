...
namespace StackOneHQ.Client
{
    ...
    public interface INotes
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="AtsListCandidateNotesRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListCandidateNotesResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListCandidateNotesResponse> ListAsync(
    ...
    public class Notes: INotes
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListCandidateNotesResponse> ListAsync(
            AtsListCandidateNotesRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_candidate_notes", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListCandidateNotesResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListCandidateNotesRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsListCandidateNotesResponse()
                    {
