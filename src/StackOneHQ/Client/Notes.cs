...
namespace StackOneHQ.Client
{
    ...
    public interface INotes
    {
        ...
        /// </summary>
        Task<AtsListCandidateNotesResponse> ListAsync(AtsListCandidateNotesRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Notes: INotes
    {
        ...
        public async Task<AtsListCandidateNotesResponse> ListAsync(AtsListCandidateNotesRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_candidate_notes", new List<string> {  }, SDKConfiguration.SecuritySource);
