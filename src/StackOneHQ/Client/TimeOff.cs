...
namespace StackOneHQ.Client
{
    ...
    public interface ITimeOff
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="HrisListTimeOffRequestsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListTimeOffRequestsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListTimeOffRequestsResponse> ListAsync(
    ...
    public class TimeOff: ITimeOff
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListTimeOffRequestsResponse> ListAsync(
            HrisListTimeOffRequestsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/time_off", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_time_off_requests", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<HrisListTimeOffRequestsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new HrisListTimeOffRequestsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisListTimeOffRequestsResponse()
                    {
