...
namespace StackOneHQ.Client
{
    ...
    public interface ITimeOff
    {
        ...
        /// </summary>
        Task<HrisListTimeOffRequestsResponse> ListAsync(HrisListTimeOffRequestsRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class TimeOff: ITimeOff
    {
        ...
        public async Task<HrisListTimeOffRequestsResponse> ListAsync(HrisListTimeOffRequestsRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/time_off", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_time_off_requests", new List<string> {  }, SDKConfiguration.SecuritySource);
