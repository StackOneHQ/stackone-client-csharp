...
namespace StackOneHQ.Client
{
    ...
    public interface IHrisLocations
    {
        ...
        /// List Work Locations.
        /// </summary>
        /// <param name="request">A <see cref="HrisListLocationsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListLocationsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListLocationsResponse> ListAsync(
    ...
    public class HrisLocations: IHrisLocations
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListLocationsResponse> ListAsync(
            HrisListLocationsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/locations", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_locations", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<HRISLocationsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into HRISLocationsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
