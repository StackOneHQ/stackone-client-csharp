...
namespace StackOneHQ.Client
{
    ...
    public interface IActions
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="StackoneListActionsMetaRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="StackoneListActionsMetaResponse"/> response envelope when completed.</returns>
        ...
        public  Task<StackoneListActionsMetaResponse> ListActionsMetaAsync(
            StackoneListActionsMetaRequest? request = null,
        ...
        /// </summary>
        /// <param name="request">A <see cref="ActionSearchDto"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="StackoneSearchActionsResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<StackoneSearchActionsResponse> SearchActionsAsync(
            ActionSearchDto request,
            RetryConfig? retryConfig = null
        );
        ...
        /// </summary>
        /// <param name="request">A <see cref="ActionBuildDto"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="StackoneBuildActionEmbeddingsResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<StackoneBuildActionEmbeddingsResponse> BuildActionEmbeddingsAsync(
            ActionBuildDto request,
            RetryConfig? retryConfig = null
        );
        ...
        /// </remarks>
        /// <param name="request">A <see cref="ActionsRpcRequestDto"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="StackoneRpcActionResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<StackoneRpcActionResponse> RpcActionAsync(
            ActionsRpcRequestDto request,
            RetryConfig? retryConfig = null
        );
    }
    ...
    public class Actions: IActions
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<StackoneListActionsMetaResponse> ListActionsMetaAsync(
            StackoneListActionsMetaRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/actions", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_list_actions_meta", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<StackoneListActionsMetaResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new StackoneListActionsMetaRequest
                {
                ...
                return await ListActionsMetaAsync (
                    request: newRequest,
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ActionsMetaPaginated>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ActionsMetaPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new StackoneListActionsMetaResponse()
                    {
                    ...
                    response.ActionsMetaPaginated = obj;
                    return response;
                }
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<StackoneSearchActionsResponse> SearchActionsAsync(
            ActionSearchDto request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = baseUrl + "/actions/search";
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_search_actions", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    ActionSearchResponseDto obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ActionSearchResponseDto>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ActionSearchResponseDto.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new StackoneSearchActionsResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.ActionSearchResponseDto = obj;
                    return response;
                }
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<StackoneBuildActionEmbeddingsResponse> BuildActionEmbeddingsAsync(
            ActionBuildDto request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = baseUrl + "/actions/build";
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_build_action_embeddings", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    ActionBuildResponseDto obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ActionBuildResponseDto>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ActionBuildResponseDto.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new StackoneBuildActionEmbeddingsResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.ActionBuildResponseDto = obj;
                    return response;
                }
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<StackoneRpcActionResponse> RpcActionAsync(
            ActionsRpcRequestDto request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = baseUrl + "/actions/rpc";
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_rpc_action", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ActionsRpcResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ActionsRpcResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new StackoneRpcActionResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.ActionsRpcResponse = obj;
                    return response;
                }
