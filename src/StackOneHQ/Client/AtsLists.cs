...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsLists
    {
        ...
        /// Get all Lists
        /// </summary>
        Task<AtsListListsResponse> ListAsync(AtsListListsRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get List
        /// </summary>
        Task<AtsGetListResponse> GetAsync(AtsGetListRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AtsLists: IAtsLists
    {
        ...
        public async Task<AtsListListsResponse> ListAsync(AtsListListsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/lists", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_lists", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/lists/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_list", new List<string> {  }, SDKConfiguration.SecuritySource);
