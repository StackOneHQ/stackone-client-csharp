...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsLists
    {
        /// <summary>
        /// Get all Lists.
        /// </summary>
        /// <param name="request">A <see cref="AtsListListsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListListsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListListsResponse> ListAsync(AtsListListsRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get List.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetListRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetListResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<AtsGetListResponse> GetAsync(AtsGetListRequest request, RetryConfig? retryConfig = null);
    }

    public class AtsLists: IAtsLists
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public AtsLists(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListListsResponse> ListAsync(AtsListListsRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/lists", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_lists", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListListsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListListsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsListListsResponse()
                    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetListResponse> GetAsync(AtsGetListRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/lists/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_list", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsGetListResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
