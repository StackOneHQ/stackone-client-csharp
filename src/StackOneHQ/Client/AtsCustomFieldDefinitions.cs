...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsCustomFieldDefinitions
    {
        ...
        /// </summary>
        Task<AtsListCandidateCustomFieldDefinitionsResponse> ListCandidatesAsync(AtsListCandidateCustomFieldDefinitionsRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get Job Custom Field Definition
        /// </summary>
        Task<AtsGetJobCustomFieldDefinitionResponse> GetJobAsync(AtsGetJobCustomFieldDefinitionRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AtsCustomFieldDefinitions: IAtsCustomFieldDefinitions
    {
        ...
        public async Task<AtsListCandidateCustomFieldDefinitionsResponse> ListCandidatesAsync(AtsListCandidateCustomFieldDefinitionsRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/custom_field_definitions/candidates", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_candidate_custom_field_definitions", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<AtsGetJobCustomFieldDefinitionResponse> GetJobAsync(AtsGetJobCustomFieldDefinitionRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/custom_field_definitions/jobs/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_job_custom_field_definition", new List<string> {  }, SDKConfiguration.SecuritySource);
