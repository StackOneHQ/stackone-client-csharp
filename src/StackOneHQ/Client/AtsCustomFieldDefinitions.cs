...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsCustomFieldDefinitions
    {
        /// <summary>
        /// List Candidate Custom Field Definitions.
        /// </summary>
        /// <param name="request">A <see cref="AtsListCandidateCustomFieldDefinitionsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListCandidateCustomFieldDefinitionsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListCandidateCustomFieldDefinitionsResponse> ListCandidatesAsync(
        ...
        /// </summary>
        /// <param name="request">A <see cref="AtsGetJobCustomFieldDefinitionRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetJobCustomFieldDefinitionResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<AtsGetJobCustomFieldDefinitionResponse> GetJobAsync(
            AtsGetJobCustomFieldDefinitionRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class AtsCustomFieldDefinitions: IAtsCustomFieldDefinitions
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public AtsCustomFieldDefinitions(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListCandidateCustomFieldDefinitionsResponse> ListCandidatesAsync(
            AtsListCandidateCustomFieldDefinitionsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/custom_field_definitions/candidates", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_candidate_custom_field_definitions", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListCandidateCustomFieldDefinitionsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListCandidateCustomFieldDefinitionsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsListCandidateCustomFieldDefinitionsResponse()
                    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetJobCustomFieldDefinitionResponse> GetJobAsync(
            AtsGetJobCustomFieldDefinitionRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/custom_field_definitions/jobs/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_job_custom_field_definition", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsGetJobCustomFieldDefinitionResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
