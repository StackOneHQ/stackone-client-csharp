...
namespace StackOneHQ.Client
{
    ...
    public interface IApplications
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="AtsGetApplicationScorecardRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetApplicationScorecardResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetApplicationScorecardResponse> GetScorecardAsync(
    ...
    public class Applications: IApplications
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetApplicationScorecardResponse> GetScorecardAsync(
            AtsGetApplicationScorecardRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/applications/{id}/scorecards/{subResourceId}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_application_scorecard", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ScorecardsResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ScorecardsResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsGetApplicationScorecardResponse()
                    {
