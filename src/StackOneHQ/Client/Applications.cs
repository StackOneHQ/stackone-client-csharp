...
namespace StackOneHQ.Client
{
    ...
    public interface IApplications
    {
        ...
        /// </summary>
        Task<AtsGetApplicationScorecardResponse> GetScorecardAsync(AtsGetApplicationScorecardRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Applications: IApplications
    {
        ...
        public async Task<AtsGetApplicationScorecardResponse> GetScorecardAsync(AtsGetApplicationScorecardRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/applications/{id}/scorecards/{subResourceId}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_application_scorecard", new List<string> {  }, SDKConfiguration.SecuritySource);
