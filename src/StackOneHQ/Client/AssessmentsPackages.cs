...
namespace StackOneHQ.Client
{
    ...
    public interface IAssessmentsPackages
    {
        /// <summary>
        /// Get Assessments Package.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetAssessmentsPackageRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetAssessmentsPackageResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetAssessmentsPackageResponse> GetAsync(
            AtsGetAssessmentsPackageRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class AssessmentsPackages: IAssessmentsPackages
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public AssessmentsPackages(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetAssessmentsPackageResponse> GetAsync(
            AtsGetAssessmentsPackageRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/assessments/packages/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_assessments_package", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AssessmentPackageResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AssessmentPackageResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsGetAssessmentsPackageResponse()
                    {
                    ...
                    response.AssessmentPackageResult = obj;
                    return response;
                }
