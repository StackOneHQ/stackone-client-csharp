...
namespace StackOneHQ.Client
{
    ...
    public interface IAssessmentsPackages
    {
        ...
        /// </summary>
        Task<AtsGetAssessmentsPackageResponse> GetAsync(AtsGetAssessmentsPackageRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AssessmentsPackages: IAssessmentsPackages
    {
        ...
        public async Task<AtsGetAssessmentsPackageResponse> GetAsync(AtsGetAssessmentsPackageRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/assessments/packages/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_assessments_package", new List<string> {  }, SDKConfiguration.SecuritySource);
