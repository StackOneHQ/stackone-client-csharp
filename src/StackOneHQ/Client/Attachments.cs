...
namespace StackOneHQ.Client
{
    ...
    public interface IAttachments
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="TicketingGetAttachmentRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="TicketingGetAttachmentResponse"/> response envelope when completed.</returns>
        ...
        public  Task<TicketingGetAttachmentResponse> GetAsync(
            TicketingGetAttachmentRequest request,
    ...
    public class Attachments: IAttachments
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<TicketingGetAttachmentResponse> GetAsync(
            TicketingGetAttachmentRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ticketing/tickets/{id}/attachments/{subResourceId}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ticketing_get_attachment", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<TicketingAttachmentResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into TicketingAttachmentResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
