...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsJobs
    {
        ...
        /// Get Job
        /// </summary>
        Task<AtsGetJobResponse> GetAsync(AtsGetJobRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AtsJobs: IAtsJobs
    {
        ...
        public async Task<AtsGetJobResponse> GetAsync(AtsGetJobRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_job", new List<string> {  }, SDKConfiguration.SecuritySource);
