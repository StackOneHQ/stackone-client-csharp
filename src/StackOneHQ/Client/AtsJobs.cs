...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsJobs
    {
        /// <summary>
        /// Get Job.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetJobRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetJobResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetJobResponse> GetAsync(AtsGetJobRequest request, RetryConfig? retryConfig = null);
    }

    public class AtsJobs: IAtsJobs
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetJobResponse> GetAsync(AtsGetJobRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_job", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AtsJobResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AtsJobResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
