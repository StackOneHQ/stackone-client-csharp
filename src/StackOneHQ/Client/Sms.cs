...
namespace StackOneHQ.Client
{
    ...
    public interface ISms
    {
        ...
        /// Get SMS Template.
        /// </summary>
        /// <param name="request">A <see cref="MarketingGetSmsTemplateRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="MarketingGetSmsTemplateResponse"/> response envelope when completed.</returns>
        ...
        public  Task<MarketingGetSmsTemplateResponse> GetAsync(
    ...
    public class Sms: ISms
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<MarketingGetSmsTemplateResponse> GetAsync(
            MarketingGetSmsTemplateRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "marketing_get_sms_template", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<SmsTemplateResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into SmsTemplateResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
