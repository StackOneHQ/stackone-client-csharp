...
namespace StackOneHQ.Client
{
    ...
    public interface IBenefits
    {
        ...
        /// Get Benefit
        /// </summary>
        Task<HrisGetBenefitResponse> GetAsync(HrisGetBenefitRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Benefits: IBenefits
    {
        ...
        public async Task<HrisGetBenefitResponse> GetAsync(HrisGetBenefitRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/benefits/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_benefit", new List<string> {  }, SDKConfiguration.SecuritySource);
