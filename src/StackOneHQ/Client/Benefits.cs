...
namespace StackOneHQ.Client
{
    ...
    public interface IBenefits
    {
        ...
        /// Get Benefit.
        /// </summary>
        /// <param name="request">A <see cref="HrisGetBenefitRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisGetBenefitResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisGetBenefitResponse> GetAsync(HrisGetBenefitRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Benefits: IBenefits
    {
        ...
        public Benefits(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisGetBenefitResponse> GetAsync(
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/benefits/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_benefit", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<HRISBenefitResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into HRISBenefitResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new HrisGetBenefitResponse()
                    {
                    ...
                    response.HRISBenefitResult = obj;
                    return response;
                }
