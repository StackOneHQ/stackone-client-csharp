...
namespace StackOneHQ.Client
{
    ...
    public interface IIamUsers
    {
        ...
        /// List Users
        /// </summary>
        Task<IamListUsersResponse> ListAsync(IamListUsersRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get User
        /// </summary>
        Task<IamGetUserResponse> GetAsync(IamGetUserRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Update User
        /// </summary>
        Task<IamUpdateUserResponse> UpdateAsync(string xAccountId, string id, IamUpdateUserRequestDto iamUpdateUserRequestDto, RetryConfig? retryConfig = null);
    }
    ...
    public class IamUsers: IIamUsers
    {
        ...
        public async Task<IamUpdateUserResponse> UpdateAsync(string xAccountId, string id, IamUpdateUserRequestDto iamUpdateUserRequestDto, RetryConfig? retryConfig = null)
        {
