...
namespace StackOneHQ.Client
{
    ...
    public interface IProxy
    {
        ...
        /// <param name="proxyRequestBody">The request body.</param>
        ...
        /// <returns>An awaitable task that returns a <see cref="StackoneProxyRequestResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="xAccountId"/> or <paramref name="proxyRequestBody"/> is null.</exception>
        ...
        public  Task<StackoneProxyRequestResponse> PerformAsync(
            string xAccountId,
    ...
    public class Proxy: IProxy
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<StackoneProxyRequestResponse> PerformAsync(
            string xAccountId,
            ProxyRequestBody proxyRequestBody,
            string? prefer = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            if (proxyRequestBody == null) throw new ArgumentNullException(nameof(proxyRequestBody));

            var request = new StackoneProxyRequestRequest()
            {
            ...
            var urlString = baseUrl + "/unified/proxy";
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "ProxyRequestBody", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "stackone_proxy_request", null, SDKConfiguration.SecuritySource);
