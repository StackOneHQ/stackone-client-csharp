...
namespace StackOneHQ.Client
{
    ...
    public interface IGroupsCompanies
    {
        ...
        /// </summary>
        Task<HrisListCompaniesGroupsResponse> ListAsync(HrisListCompaniesGroupsRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class GroupsCompanies: IGroupsCompanies
    {
        ...
        public async Task<HrisListCompaniesGroupsResponse> ListAsync(HrisListCompaniesGroupsRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/companies", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_companies_groups", new List<string> {  }, SDKConfiguration.SecuritySource);
