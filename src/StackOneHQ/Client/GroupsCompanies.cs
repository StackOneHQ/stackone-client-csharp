...
namespace StackOneHQ.Client
{
    ...
    public interface IGroupsCompanies
    {
        /// <summary>
        /// List Companies Groups.
        /// </summary>
        /// <param name="request">A <see cref="HrisListCompaniesGroupsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListCompaniesGroupsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListCompaniesGroupsResponse> ListAsync(
            HrisListCompaniesGroupsRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class GroupsCompanies: IGroupsCompanies
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public GroupsCompanies(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListCompaniesGroupsResponse> ListAsync(
            HrisListCompaniesGroupsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/companies", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_companies_groups", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<HrisListCompaniesGroupsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new HrisListCompaniesGroupsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisListCompaniesGroupsResponse()
                    {
