...
namespace StackOneHQ.Client
{
    ...
    public interface ITimeOffTypes
    {
        ...
        /// Get time off type
        /// </summary>
        Task<HrisGetTimeOffTypeResponse> GetAsync(HrisGetTimeOffTypeRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class TimeOffTypes: ITimeOffTypes
    {
        ...
        public async Task<HrisGetTimeOffTypeResponse> GetAsync(HrisGetTimeOffTypeRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/time_off_types/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_time_off_type", new List<string> {  }, SDKConfiguration.SecuritySource);
