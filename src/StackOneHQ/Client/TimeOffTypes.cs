...
namespace StackOneHQ.Client
{
    ...
    public interface ITimeOffTypes
    {
        /// <summary>
        /// Get time off type.
        /// </summary>
        /// <param name="request">A <see cref="HrisGetTimeOffTypeRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisGetTimeOffTypeResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisGetTimeOffTypeResponse> GetAsync(
            HrisGetTimeOffTypeRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class TimeOffTypes: ITimeOffTypes
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public TimeOffTypes(SDKConfig config)
        {
        ...
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public async  Task<HrisGetTimeOffTypeResponse> GetAsync(
            HrisGetTimeOffTypeRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/time_off_types/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_time_off_type", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisGetTimeOffTypeResponse()
                    {
