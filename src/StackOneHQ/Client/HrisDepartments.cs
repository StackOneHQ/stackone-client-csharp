...
namespace StackOneHQ.Client
{
    ...
    public interface IHrisDepartments
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="HrisGetDepartmentGroupRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisGetDepartmentGroupResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisGetDepartmentGroupResponse> GetAsync(
    ...
    public class HrisDepartments: IHrisDepartments
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisGetDepartmentGroupResponse> GetAsync(
            HrisGetDepartmentGroupRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/departments/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_department_group", null, SDKConfiguration.SecuritySource);
