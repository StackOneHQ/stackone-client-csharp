...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployeeCategories
    {
        ...
        /// </summary>
        Task<HrisListEmployeeCategoriesResponse> ListAsync(HrisListEmployeeCategoriesRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get Employee Document Category
        /// </summary>
        Task<HrisGetEmployeeDocumentCategoryResponse> GetAsync(HrisGetEmployeeDocumentCategoryRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class EmployeeCategories: IEmployeeCategories
    {
        ...
        public async Task<HrisListEmployeeCategoriesResponse> ListAsync(HrisListEmployeeCategoriesRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/documents/employee_categories", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_employee_categories", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<HrisGetEmployeeDocumentCategoryResponse> GetAsync(HrisGetEmployeeDocumentCategoryRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/documents/employee_categories/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_employee_document_category", new List<string> {  }, SDKConfiguration.SecuritySource);
