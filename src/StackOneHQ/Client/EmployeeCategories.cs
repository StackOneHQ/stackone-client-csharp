...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployeeCategories
    {
        /// <summary>
        /// List Employee Document Categories.
        /// </summary>
        /// <param name="request">A <see cref="HrisListEmployeeCategoriesRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListEmployeeCategoriesResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListEmployeeCategoriesResponse> ListAsync(
        ...
        /// </summary>
        /// <param name="request">A <see cref="HrisGetEmployeeDocumentCategoryRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisGetEmployeeDocumentCategoryResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<HrisGetEmployeeDocumentCategoryResponse> GetAsync(
            HrisGetEmployeeDocumentCategoryRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class EmployeeCategories: IEmployeeCategories
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public EmployeeCategories(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListEmployeeCategoriesResponse> ListAsync(
            HrisListEmployeeCategoriesRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/documents/employee_categories", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_employee_categories", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<HrisListEmployeeCategoriesResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new HrisListEmployeeCategoriesRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisListEmployeeCategoriesResponse()
                    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisGetEmployeeDocumentCategoryResponse> GetAsync(
            HrisGetEmployeeDocumentCategoryRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/documents/employee_categories/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_employee_document_category", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ReferenceResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ReferenceResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new HrisGetEmployeeDocumentCategoryResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
