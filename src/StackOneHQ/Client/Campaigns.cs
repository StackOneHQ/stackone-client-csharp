...
namespace StackOneHQ.Client
{
    ...
    public interface ICampaigns
    {
        ...
        /// List campaigns.
        /// </summary>
        /// <param name="request">A <see cref="MarketingListCampaignsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="MarketingListCampaignsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<MarketingListCampaignsResponse> ListAsync(
        ...
        /// Get campaign.
        /// </summary>
        /// <param name="request">A <see cref="MarketingGetCampaignRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="MarketingGetCampaignResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<MarketingGetCampaignResponse> GetAsync(
    ...
    public class Campaigns: ICampaigns
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<MarketingListCampaignsResponse> ListAsync(
            MarketingListCampaignsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/marketing/campaigns", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "marketing_list_campaigns", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CampaignsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CampaignsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<MarketingGetCampaignResponse> GetAsync(
            MarketingGetCampaignRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/marketing/campaigns/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "marketing_get_campaign", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CampaignResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CampaignResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
