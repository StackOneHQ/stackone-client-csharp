...
namespace StackOneHQ.Client
{
    ...
    public interface ILmsSkills
    {
        /// <summary>
        /// Get Skill.
        /// </summary>
        /// <param name="request">A <see cref="LmsGetSkillRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="LmsGetSkillResponse"/> response envelope when completed.</returns>
        ...
        public  Task<LmsGetSkillResponse> GetAsync(LmsGetSkillRequest request, RetryConfig? retryConfig = null);
    }

    public class LmsSkills: ILmsSkills
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public LmsSkills(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsGetSkillResponse> GetAsync(LmsGetSkillRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/lms/skills/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_get_skill", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<SkillResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into SkillResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
