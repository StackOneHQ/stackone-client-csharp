...
namespace StackOneHQ.Client
{
    ...
    public interface IPolicies
    {
        ...
        /// Get Policy.
        /// </summary>
        /// <param name="request">A <see cref="IamGetPolicyRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="IamGetPolicyResponse"/> response envelope when completed.</returns>
        ...
        public  Task<IamGetPolicyResponse> GetAsync(IamGetPolicyRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Policies: IPolicies
    {
        ...
        public Policies(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<IamGetPolicyResponse> GetAsync(IamGetPolicyRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/iam/policies/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "iam_get_policy", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<IamPolicyResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into IamPolicyResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
