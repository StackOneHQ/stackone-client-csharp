...
namespace StackOneHQ.Client
{
    ...
    public interface IInterviews
    {
        ...
        /// Get Interview
        /// </summary>
        Task<AtsGetInterviewResponse> GetAsync(AtsGetInterviewRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Interviews: IInterviews
    {
        ...
        public async Task<AtsGetInterviewResponse> GetAsync(AtsGetInterviewRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/interviews/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_interview", new List<string> {  }, SDKConfiguration.SecuritySource);
