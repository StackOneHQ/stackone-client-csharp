...
namespace StackOneHQ.Client
{
    ...
    public interface IInterviews
    {
        ...
        /// Get Interview.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetInterviewRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetInterviewResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetInterviewResponse> GetAsync(AtsGetInterviewRequest request, RetryConfig? retryConfig = null);
    }

    public class Interviews: IInterviews
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public Interviews(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetInterviewResponse> GetAsync(
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/interviews/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_interview", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<InterviewsResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into InterviewsResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsGetInterviewResponse()
                    {
