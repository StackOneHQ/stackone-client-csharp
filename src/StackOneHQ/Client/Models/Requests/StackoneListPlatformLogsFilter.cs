...
namespace StackOneHQ.Client.Models.Requests
{
    ...
    /// </summary>
    public class StackoneListPlatformLogsFilter
    {
        ...
        public StackoneListPlatformLogsFilterOrderBy? OrderBy { get; set; } = null;

        /// <summary>
        /// The direction to order the results by.
        /// </summary>
        [SpeakeasyMetadata("queryParam:name=order_direction")]
        public StackoneListPlatformLogsFilterOrderDirection? OrderDirection { get; set; } = null;
    }
}