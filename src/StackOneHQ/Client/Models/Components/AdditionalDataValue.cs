...
namespace StackOneHQ.Client.Models.Components
{
    ...
    public class AdditionalDataValueType
    {
        ...
        public static implicit operator String(AdditionalDataValueType v) { return v.Value; }
        public static AdditionalDataValueType FromString(string v) {
            switch(v) {
                case "str": return Str;
                case "arrayOfStr": return ArrayOfStr;
                case "null": return Null;
                default: throw new ArgumentException("Invalid value for AdditionalDataValueType");
            }
        }
        public override bool Equals(object? obj)
        {
            ...
            return Value.Equals(((AdditionalDataValueType)obj).Value);
        }
    ...
    public class AdditionalDataValue
    {
        ...
        public class AdditionalDataValueConverter : JsonConverter
        {

            public override bool CanConvert(System.Type objectType) => objectType == typeof(AdditionalDataValue);
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                if (json[0] == '"' && json[^1] == '"'){
                    return new AdditionalDataValue(AdditionalDataValueType.Str)
                    {
                        Str = json[1..^1]
                    };
                }
                ...
                try
                {
                    return new AdditionalDataValue(AdditionalDataValueType.ArrayOfStr)
                    {
                ...
                {
                    fallbackCandidates.Add((typeof(List<string>), new AdditionalDataValue(AdditionalDataValueType.ArrayOfStr), "ArrayOfStr"));
                }
