...
namespace StackOneHQ.Client.Models.Components
{
    ...
    public class AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType
    {
        ...
        public static implicit operator String(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType v) { return v.Value; }
        public static AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType FromString(string v) {
            switch(v) {
                case "str": return Str;
                case "number": return Number;
                case "boolean": return Boolean;
                case "AtsDocumentsUploadRequestDto_source_value_confidential": return AtsDocumentsUploadRequestDtoSourceValueConfidential;
                case "arrayOfAny": return ArrayOfAny;
                case "null": return Null;
                default: throw new ArgumentException("Invalid value for AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType");
            }
        }
        public override bool Equals(object? obj)
        {
            ...
            return Value.Equals(((AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType)obj).Value);
        }
    ...
    public class AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion
    {
        ...
        [SpeakeasyMetadata("form:explode=true")]
        public AtsDocumentsUploadRequestDtoSourceValueConfidential? AtsDocumentsUploadRequestDtoSourceValueConfidential { get; set; }
        ...
        public class AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionConverter : JsonConverter
        {
            public override bool CanConvert(System.Type objectType) => objectType == typeof(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion);
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                try
                {
                    return new AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType.AtsDocumentsUploadRequestDtoSourceValueConfidential)
                    {
                        AtsDocumentsUploadRequestDtoSourceValueConfidential = ResponseBodyDeserializer.DeserializeUndiscriminatedUnionMember<AtsDocumentsUploadRequestDtoSourceValueConfidential>(json)
                    };
                }
                catch (ResponseBodyDeserializer.MissingMemberException)
                {
                    fallbackCandidates.Add((typeof(AtsDocumentsUploadRequestDtoSourceValueConfidential), new AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType.AtsDocumentsUploadRequestDtoSourceValueConfidential), "AtsDocumentsUploadRequestDtoSourceValueConfidential"));
                }
                ...
                if (json[0] == '"' && json[^1] == '"'){
                    return new AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType.Str)
                    {
                        Str = json[1..^1]
                    };
                }
                ...
                try
                {
                    ...
                    return new AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType.Number)
                    {
                        Number = converted
                    };
                }
                ...
                try
                {
                    ...
                    return new AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType.Boolean)
                    {
                        Boolean = converted
                    };
                }
                ...
                try
                {
                    return new AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType.ArrayOfAny)
                    {
                ...
                {
                    fallbackCandidates.Add((typeof(List<object>), new AtsDocumentsUploadRequestDtoConfidentialSourceValueUnion(AtsDocumentsUploadRequestDtoConfidentialSourceValueUnionType.ArrayOfAny), "ArrayOfAny"));
                }
                catch (ResponseBodyDeserializer.DeserializationException)
                {
                    // try next option
