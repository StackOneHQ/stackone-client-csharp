...
namespace StackOneHQ.Client.Models.Components
{
    ...
    public class AtsDocumentApiModelFileFormatSourceValueUnionType
    {
        ...
        public static implicit operator String(AtsDocumentApiModelFileFormatSourceValueUnionType v) { return v.Value; }
        public static AtsDocumentApiModelFileFormatSourceValueUnionType FromString(string v) {
            switch(v) {
                case "str": return Str;
                case "number": return Number;
                case "boolean": return Boolean;
                case "AtsDocumentApiModel_source_value_file_format": return AtsDocumentApiModelSourceValueFileFormat;
                case "arrayOfAny": return ArrayOfAny;
                case "null": return Null;
                default: throw new ArgumentException("Invalid value for AtsDocumentApiModelFileFormatSourceValueUnionType");
            }
        }
        public override bool Equals(object? obj)
        {
            ...
            return Value.Equals(((AtsDocumentApiModelFileFormatSourceValueUnionType)obj).Value);
        }
    ...
    public class AtsDocumentApiModelFileFormatSourceValueUnion
    {
        ...
        [SpeakeasyMetadata("form:explode=true")]
        public AtsDocumentApiModelSourceValueFileFormat? AtsDocumentApiModelSourceValueFileFormat { get; set; }
        ...
        public class AtsDocumentApiModelFileFormatSourceValueUnionConverter : JsonConverter
        {
            public override bool CanConvert(System.Type objectType) => objectType == typeof(AtsDocumentApiModelFileFormatSourceValueUnion);
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                try
                {
                    return new AtsDocumentApiModelFileFormatSourceValueUnion(AtsDocumentApiModelFileFormatSourceValueUnionType.AtsDocumentApiModelSourceValueFileFormat)
                    {
                        AtsDocumentApiModelSourceValueFileFormat = ResponseBodyDeserializer.DeserializeUndiscriminatedUnionMember<AtsDocumentApiModelSourceValueFileFormat>(json)
                    };
                }
                catch (ResponseBodyDeserializer.MissingMemberException)
                {
                    fallbackCandidates.Add((typeof(AtsDocumentApiModelSourceValueFileFormat), new AtsDocumentApiModelFileFormatSourceValueUnion(AtsDocumentApiModelFileFormatSourceValueUnionType.AtsDocumentApiModelSourceValueFileFormat), "AtsDocumentApiModelSourceValueFileFormat"));
                }
                ...
                if (json[0] == '"' && json[^1] == '"'){
                    return new AtsDocumentApiModelFileFormatSourceValueUnion(AtsDocumentApiModelFileFormatSourceValueUnionType.Str)
                    {
                        Str = json[1..^1]
                    };
                }
                ...
                try
                {
                    ...
                    return new AtsDocumentApiModelFileFormatSourceValueUnion(AtsDocumentApiModelFileFormatSourceValueUnionType.Number)
                    {
                        Number = converted
                    };
                }
                ...
                try
                {
                    ...
                    return new AtsDocumentApiModelFileFormatSourceValueUnion(AtsDocumentApiModelFileFormatSourceValueUnionType.Boolean)
                    {
                        Boolean = converted
                    };
                }
                ...
                try
                {
                    return new AtsDocumentApiModelFileFormatSourceValueUnion(AtsDocumentApiModelFileFormatSourceValueUnionType.ArrayOfAny)
                    {
                ...
                {
                    fallbackCandidates.Add((typeof(List<object>), new AtsDocumentApiModelFileFormatSourceValueUnion(AtsDocumentApiModelFileFormatSourceValueUnionType.ArrayOfAny), "ArrayOfAny"));
                }
                catch (ResponseBodyDeserializer.DeserializationException)
                {
                    // try next option
