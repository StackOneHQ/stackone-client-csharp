...
namespace StackOneHQ.Client.Models.Components
{
    ...
    public class ContentActiveUnionType
    {
        ...
        public static implicit operator String(ContentActiveUnionType v) { return v.Value; }
        public static ContentActiveUnionType FromString(string v) {
            switch(v) {
                case "boolean": return Boolean;
                case "Content_active_enum": return ContentActiveEnum;
                case "null": return Null;
                default: throw new ArgumentException("Invalid value for ContentActiveUnionType");
            }
        }
        public override bool Equals(object? obj)
        {
            ...
            return Value.Equals(((ContentActiveUnionType)obj).Value);
        }
    ...
    public class ContentActiveUnion {
        ...
        public static ContentActiveUnion CreateContentActiveEnum(ContentActiveEnum contentActiveEnum) {
            ...
            ContentActiveUnion res = new ContentActiveUnion(typ);
            res.ContentActiveEnum = contentActiveEnum;
            return res;
        }
        ...
        public class ContentActiveUnionConverter : JsonConverter
        {

            public override bool CanConvert(System.Type objectType) => objectType == typeof(ContentActiveUnion);
            ...
            public override object? ReadJson(JsonReader reader, System.Type objectType, object? existingValue, JsonSerializer serializer)
            {
                ...
                try
                {
                    ...
                    return new ContentActiveUnion(ContentActiveUnionType.Boolean)
                    {
                        Boolean = converted
                    };
                }
                ...
                try
                {
                    return new ContentActiveUnion(ContentActiveUnionType.ContentActiveEnum)
                    {
                        ContentActiveEnum = ResponseBodyDeserializer.DeserializeUndiscriminatedUnionMember<ContentActiveEnum>(json)
                    };
                }
                catch (ResponseBodyDeserializer.MissingMemberException)
                {
                    fallbackCandidates.Add((typeof(ContentActiveEnum), new ContentActiveUnion(ContentActiveUnionType.ContentActiveEnum), "ContentActiveEnum"));
                }
