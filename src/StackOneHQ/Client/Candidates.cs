...
namespace StackOneHQ.Client
{
    ...
    public interface ICandidates
    {
        ...
        public ICandidatesCustomFieldDefinitions CustomFieldDefinitions { get; }
        /// <summary>
        /// Create Candidate.
        /// </summary>
        /// <param name="xAccountId">The account identifier.</param>
        /// <param name="atsCreateCandidateRequestDto">A <see cref="AtsCreateCandidateRequestDto"/> parameter.</param>
        ...
        /// <returns>An awaitable task that returns a <see cref="AtsCreateCandidateResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="xAccountId"/> or <paramref name="atsCreateCandidateRequestDto"/> is null.</exception>
        ...
        public  Task<AtsCreateCandidateResponse> CreateAsync(
            string xAccountId,
        ...
        /// Get Candidate.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetCandidateRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetCandidateResponse"/> response envelope when completed.</returns>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<AtsGetCandidateResponse> GetAsync(AtsGetCandidateRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Candidates: ICandidates
    {
        ...
        /// <see cref="ICandidatesCustomFieldDefinitions"/>
        /// </summary>
        public ICandidatesCustomFieldDefinitions CustomFieldDefinitions { get; private set; }

        public Candidates(SDKConfig config)
        {
            SDKConfiguration = config;
            Notes = new Notes(SDKConfiguration);
            CustomFieldDefinitions = new CandidatesCustomFieldDefinitions(SDKConfiguration);
        }
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsCreateCandidateResponse> CreateAsync(
            string xAccountId,
            AtsCreateCandidateRequestDto atsCreateCandidateRequestDto,
            string? prefer = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            if (atsCreateCandidateRequestDto == null) throw new ArgumentNullException(nameof(atsCreateCandidateRequestDto));

            var request = new AtsCreateCandidateRequest()
            {
            ...
            var urlString = baseUrl + "/unified/ats/candidates";
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "AtsCreateCandidateRequestDto", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_create_candidate", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsCreateCandidateResponse()
                    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetCandidateResponse> GetAsync(
        ...
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_candidate", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CandidateResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CandidateResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsGetCandidateResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
