...
namespace StackOneHQ.Client
{
    ...
    public interface ICostCenters
    {
        ...
        /// </summary>
        Task<HrisGetCostCenterGroupResponse> GetAsync(HrisGetCostCenterGroupRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class CostCenters: ICostCenters
    {
        ...
        public async Task<HrisGetCostCenterGroupResponse> GetAsync(HrisGetCostCenterGroupRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/cost_centers/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_cost_center_group", new List<string> {  }, SDKConfiguration.SecuritySource);
