...
namespace StackOneHQ.Client
{
    ...
    public interface ICostCenters
    {
        /// <summary>
        /// Get Cost Center Group.
        /// </summary>
        /// <param name="request">A <see cref="HrisGetCostCenterGroupRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisGetCostCenterGroupResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisGetCostCenterGroupResponse> GetAsync(
            HrisGetCostCenterGroupRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class CostCenters: ICostCenters
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisGetCostCenterGroupResponse> GetAsync(
            HrisGetCostCenterGroupRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/groups/cost_centers/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_cost_center_group", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<HRISCostCenterResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into HRISCostCenterResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new HrisGetCostCenterGroupResponse()
                    {
                    ...
                    response.HRISCostCenterResult = obj;
                    return response;
                }
