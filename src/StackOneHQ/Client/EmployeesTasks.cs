...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployeesTasks
    {
        ...
        /// List Employee Tasks.
        /// </summary>
        /// <param name="request">A <see cref="HrisListEmployeeTasksRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListEmployeeTasksResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListEmployeeTasksResponse> ListAsync(
        ...
        /// </summary>
        /// <param name="request">A <see cref="HrisUpdateEmployeeTaskRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisUpdateEmployeeTaskResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<HrisUpdateEmployeeTaskResponse> CompleteAsync(
    ...
    public class EmployeesTasks: IEmployeesTasks
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListEmployeeTasksResponse> ListAsync(
            HrisListEmployeeTasksRequest request,
            RetryConfig? retryConfig = null
        )
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisUpdateEmployeeTaskResponse> CompleteAsync(
            HrisUpdateEmployeeTaskRequest request,
            RetryConfig? retryConfig = null
        )
        {
