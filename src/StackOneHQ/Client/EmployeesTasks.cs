...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployeesTasks
    {

        /// <summary>
        /// List Employee Tasks
        /// </summary>
        Task<HrisListEmployeeTasksResponse> ListAsync(HrisListEmployeeTasksRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Update Employee Task
        /// </summary>
        Task<HrisUpdateEmployeeTaskResponse> CompleteAsync(string xAccountId, string id, string subResourceId, UpdateTaskRequestDto updateTaskRequestDto, RetryConfig? retryConfig = null);
    }

    public class EmployeesTasks: IEmployeesTasks
    {
        ...
        public EmployeesTasks(SDKConfig config)
        {
            SDKConfiguration = config;
        }

        public async Task<HrisListEmployeeTasksResponse> ListAsync(HrisListEmployeeTasksRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/employees/{id}/tasks", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_employee_tasks", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            Func<Task<HrisListEmployeeTasksResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new HrisListEmployeeTasksRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<TasksPaginated>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new HrisListEmployeeTasksResponse()
                    {
        ...
        public async Task<HrisUpdateEmployeeTaskResponse> CompleteAsync(string xAccountId, string id, string subResourceId, UpdateTaskRequestDto updateTaskRequestDto, RetryConfig? retryConfig = null)
        {
            var request = new HrisUpdateEmployeeTaskRequest()
            {
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "UpdateTaskRequestDto", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_update_employee_task", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisUpdateEmployeeTaskResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
