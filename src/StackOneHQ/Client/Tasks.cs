...
namespace StackOneHQ.Client
{
    ...
    public interface ITasks
    {
        ...
        /// List Tasks
        /// </summary>
        Task<HrisListTasksResponse> ListAsync(HrisListTasksRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Tasks: ITasks
    {
        ...
        public async Task<HrisListTasksResponse> ListAsync(HrisListTasksRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/tasks", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_tasks", new List<string> {  }, SDKConfiguration.SecuritySource);
