...
namespace StackOneHQ.Client
{
    ...
    public interface ITasks
    {
        ...
        /// List Tasks.
        /// </summary>
        /// <param name="request">A <see cref="HrisListTasksRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListTasksResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListTasksResponse> ListAsync(HrisListTasksRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Tasks: ITasks
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListTasksResponse> ListAsync(
            HrisListTasksRequest request,
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/tasks", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_tasks", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<HrisListTasksResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new HrisListTasksRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisListTasksResponse()
                    {
