...
namespace StackOneHQ.Client
{
    ...
    public interface IApplicationsDocuments
    {
        /// <summary>
        /// List Application Documents.
        /// </summary>
        /// <param name="request">A <see cref="AtsListApplicationDocumentsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListApplicationDocumentsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListApplicationDocumentsResponse> ListAsync(
            AtsListApplicationDocumentsRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class ApplicationsDocuments: IApplicationsDocuments
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public ApplicationsDocuments(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListApplicationDocumentsResponse> ListAsync(
            AtsListApplicationDocumentsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/applications/{id}/documents", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_application_documents", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListApplicationDocumentsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListApplicationDocumentsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AtsDocumentsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AtsDocumentsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsListApplicationDocumentsResponse()
                    {
                    ...
                    response.AtsDocumentsPaginated = obj;
                    return response;
                }
