...
namespace StackOneHQ.Client
{
    ...
    public interface IApplicationsDocuments
    {
        ...
        /// </summary>
        Task<AtsListApplicationDocumentsResponse> ListAsync(AtsListApplicationDocumentsRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class ApplicationsDocuments: IApplicationsDocuments
    {
        ...
        public async Task<AtsListApplicationDocumentsResponse> ListAsync(AtsListApplicationDocumentsRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/applications/{id}/documents", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_application_documents", new List<string> {  }, SDKConfiguration.SecuritySource);
