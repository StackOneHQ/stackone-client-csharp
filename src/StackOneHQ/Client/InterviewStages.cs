...
namespace StackOneHQ.Client
{
    ...
    public interface IInterviewStages
    {
        ...
        /// </summary>
        Task<AtsListInterviewStagesResponse> ListAsync(AtsListInterviewStagesRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get Interview Stage
        /// </summary>
        Task<AtsGetInterviewStageResponse> GetAsync(AtsGetInterviewStageRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class InterviewStages: IInterviewStages
    {
        ...
        public async Task<AtsListInterviewStagesResponse> ListAsync(AtsListInterviewStagesRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/interview_stages", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_interview_stages", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public async Task<AtsGetInterviewStageResponse> GetAsync(AtsGetInterviewStageRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/interview_stages/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_interview_stage", new List<string> {  }, SDKConfiguration.SecuritySource);
