...
namespace StackOneHQ.Client
{
    ...
    public interface IInterviewStages
    {
        /// <summary>
        /// List Interview Stages.
        /// </summary>
        /// <param name="request">A <see cref="AtsListInterviewStagesRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListInterviewStagesResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListInterviewStagesResponse> ListAsync(
        ...
        /// Get Interview Stage.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetInterviewStageRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetInterviewStageResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public  Task<AtsGetInterviewStageResponse> GetAsync(
            AtsGetInterviewStageRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class InterviewStages: IInterviewStages
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public InterviewStages(SDKConfig config)
        {
        ...
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public async  Task<AtsListInterviewStagesResponse> ListAsync(
            AtsListInterviewStagesRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/interview_stages", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_interview_stages", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListInterviewStagesResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListInterviewStagesRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsListInterviewStagesResponse()
                    {
        ...
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public async  Task<AtsGetInterviewStageResponse> GetAsync(
            AtsGetInterviewStageRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/interview_stages/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_interview_stage", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new AtsGetInterviewStageResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
