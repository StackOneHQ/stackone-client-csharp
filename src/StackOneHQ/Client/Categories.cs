...
namespace StackOneHQ.Client
{
    ...
    public interface ICategories
    {
        ...
        /// List Categories.
        /// </summary>
        /// <param name="request">A <see cref="LmsListCategoriesRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="LmsListCategoriesResponse"/> response envelope when completed.</returns>
        ...
        public  Task<LmsListCategoriesResponse> ListAsync(
    ...
    public class Categories: ICategories
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<LmsListCategoriesResponse> ListAsync(
            LmsListCategoriesRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/lms/categories", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "lms_list_categories", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CategoriesPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CategoriesPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
