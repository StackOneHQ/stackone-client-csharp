...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsBackgroundChecks
    {
        ...
        /// </summary>
        Task<AtsGetBackgroundCheckResultResponse> GetResultsAsync(AtsGetBackgroundCheckResultRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AtsBackgroundChecks: IAtsBackgroundChecks
    {
        ...
        public async Task<AtsListBackgroundCheckPackagesResponse> PackagesListAsync(AtsListBackgroundCheckPackagesRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_background_check_packages", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<BackgroundCheckPackagePaginated>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
        ...
        public async Task<AtsCreateBackgroundCheckPackageResponse> CreatePackageAsync(string xAccountId, AtsCreateBackgroundCheckPackagesRequestDto atsCreateBackgroundCheckPackagesRequestDto, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_create_background_check_package", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<AtsGetBackgroundCheckResultResponse> GetResultsAsync(AtsGetBackgroundCheckResultRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/background_checks/orders/{id}/results", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_background_check_result", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<BackgroundCheckResultsResult>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new AtsGetBackgroundCheckResultResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.BackgroundCheckResultsResult = obj;
                    return response;
                }
