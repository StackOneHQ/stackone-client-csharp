...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsBackgroundChecks
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="AtsListBackgroundCheckPackagesRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListBackgroundCheckPackagesResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListBackgroundCheckPackagesResponse> PackagesListAsync(
        ...
        /// <param name="atsCreateBackgroundCheckPackagesRequestDto">A <see cref="AtsCreateBackgroundCheckPackagesRequestDto"/> parameter.</param>
        ...
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsCreateBackgroundCheckPackageResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="xAccountId"/> or <paramref name="atsCreateBackgroundCheckPackagesRequestDto"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="UnauthorizedResponseException">Unauthorized access. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<AtsCreateBackgroundCheckPackageResponse> CreatePackageAsync(
            string xAccountId,
    ...
    public class AtsBackgroundChecks: IAtsBackgroundChecks
    {
        ...
        /// <summary>
        /// Packages SubSDK.
        /// <see cref="IBackgroundChecksPackages"/>
        /// </summary>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListBackgroundCheckPackagesResponse> PackagesListAsync(
            AtsListBackgroundCheckPackagesRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/background_checks/packages", request, null);
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsCreateBackgroundCheckPackageResponse> CreatePackageAsync(
            string xAccountId,
            AtsCreateBackgroundCheckPackagesRequestDto atsCreateBackgroundCheckPackagesRequestDto,
            string? prefer = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            if (atsCreateBackgroundCheckPackagesRequestDto == null) throw new ArgumentNullException(nameof(atsCreateBackgroundCheckPackagesRequestDto));
