...
namespace StackOneHQ.Client
{
    ...
    public interface IAtsLocations
    {
        ...
        /// List locations
        /// </summary>
        Task<AtsListLocationsResponse> ListAsync(AtsListLocationsRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Get Location
        /// </summary>
        Task<AtsGetLocationResponse> GetAsync(AtsGetLocationRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class AtsLocations: IAtsLocations
    {
        ...
        public async Task<AtsListLocationsResponse> ListAsync(AtsListLocationsRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/locations", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_locations", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<AtsGetLocationResponse> GetAsync(AtsGetLocationRequest request, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/ats/locations/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_location", new List<string> {  }, SDKConfiguration.SecuritySource);
