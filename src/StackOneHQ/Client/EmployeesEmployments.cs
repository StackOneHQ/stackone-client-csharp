...
namespace StackOneHQ.Client
{
    ...
    public class EmployeesEmployments: IEmployeesEmployments
    {
        ...
        public async Task<HrisListEmployeeEmploymentsResponse> ListAsync(HrisListEmployeeEmploymentsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_employee_employments", null, SDKConfiguration.SecuritySource);
        ...
        public async Task<HrisUpdateEmployeeEmploymentResponse> UpdateAsync(string xAccountId, string id, string subResourceId, HrisUpdateEmploymentRequestDto hrisUpdateEmploymentRequestDto, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_update_employee_employment", null, SDKConfiguration.SecuritySource);
