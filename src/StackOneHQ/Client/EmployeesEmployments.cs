...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployeesEmployments
    {
        ...
        /// </summary>
        /// <param name="request">A <see cref="HrisListEmployeeEmploymentsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisListEmployeeEmploymentsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisListEmployeeEmploymentsResponse> ListAsync(
        ...
        /// </summary>
        /// <param name="request">A <see cref="HrisUpdateEmployeeEmploymentRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisUpdateEmployeeEmploymentResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<HrisUpdateEmployeeEmploymentResponse> UpdateAsync(
    ...
    public class EmployeesEmployments: IEmployeesEmployments
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisListEmployeeEmploymentsResponse> ListAsync(
            HrisListEmployeeEmploymentsRequest request,
            RetryConfig? retryConfig = null
        )
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisUpdateEmployeeEmploymentResponse> UpdateAsync(
            HrisUpdateEmployeeEmploymentRequest request,
            RetryConfig? retryConfig = null
        )
        {
