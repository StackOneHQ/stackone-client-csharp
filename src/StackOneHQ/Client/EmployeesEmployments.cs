        ...
        public async Task<HrisListEmployeeEmploymentsResponse> ListAsync(HrisListEmployeeEmploymentsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<EmploymentsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into EmploymentsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
