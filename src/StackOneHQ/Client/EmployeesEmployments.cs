...
namespace StackOneHQ.Client
{
    ...
    public interface IEmployeesEmployments
    {

        /// <summary>
        /// List Employee Employments
        /// </summary>
        Task<HrisListEmployeeEmploymentsResponse> ListAsync(HrisListEmployeeEmploymentsRequest request, RetryConfig? retryConfig = null);

        /// <summary>
        /// Update Employee Employment
        /// </summary>
        Task<HrisUpdateEmployeeEmploymentResponse> UpdateAsync(string xAccountId, string id, string subResourceId, HrisUpdateEmploymentRequestDto hrisUpdateEmploymentRequestDto, RetryConfig? retryConfig = null);
    }

    public class EmployeesEmployments: IEmployeesEmployments
    {
        ...
        public EmployeesEmployments(SDKConfig config)
        {
            SDKConfiguration = config;
        }

        public async Task<HrisListEmployeeEmploymentsResponse> ListAsync(HrisListEmployeeEmploymentsRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_list_employee_employments", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            Func<Task<HrisListEmployeeEmploymentsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new HrisListEmployeeEmploymentsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<EmploymentsPaginated>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new HrisListEmployeeEmploymentsResponse()
                    {
                    ...
                    response.EmploymentsPaginated = obj;
                    return response;
                }
        ...
        public async Task<HrisUpdateEmployeeEmploymentResponse> UpdateAsync(string xAccountId, string id, string subResourceId, HrisUpdateEmploymentRequestDto hrisUpdateEmploymentRequestDto, RetryConfig? retryConfig = null)
        {
            var request = new HrisUpdateEmployeeEmploymentRequest()
            {
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "HrisUpdateEmploymentRequestDto", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_update_employee_employment", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisUpdateEmployeeEmploymentResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
