...
namespace StackOneHQ.Client
{
    ...
    public interface IInApp
    {
        ...
        /// Get In-App Template.
        /// </summary>
        /// <param name="request">A <see cref="MarketingGetInAppTemplateRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="MarketingGetInAppTemplateResponse"/> response envelope when completed.</returns>
        ...
        public  Task<MarketingGetInAppTemplateResponse> GetAsync(
        ...
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="MarketingUpdateInAppTemplateResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="xAccountId"/>, <paramref name="id"/> or <paramref name="marketingCreateInAppTemplateRequestDto"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="UnauthorizedResponseException">Unauthorized access. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<MarketingUpdateInAppTemplateResponse> UpdateAsync(
            string xAccountId,
            string id,
    ...
    public class InApp: IInApp
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<MarketingGetInAppTemplateResponse> GetAsync(
            MarketingGetInAppTemplateRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/marketing/templates/in_app/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "marketing_get_in_app_template", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<InAppTemplateResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into InAppTemplateResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<MarketingUpdateInAppTemplateResponse> UpdateAsync(
            string xAccountId,
            string id,
            MarketingCreateInAppTemplateRequestDto marketingCreateInAppTemplateRequestDto,
            string? prefer = null,
        ...
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "marketing_update_in_app_template", null, SDKConfiguration.SecuritySource);
