...
namespace StackOneHQ.Client
{
    ...
    public interface ITicketingUsers
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="TicketingListUsersRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="TicketingListUsersResponse"/> response envelope when completed.</returns>
        ...
        public  Task<TicketingListUsersResponse> ListAsync(
            TicketingListUsersRequest request,
    ...
    public class TicketingUsers: ITicketingUsers
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<TicketingListUsersResponse> ListAsync(
            TicketingListUsersRequest request,
            RetryConfig? retryConfig = null
        )
        {
