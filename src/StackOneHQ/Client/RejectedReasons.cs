...
namespace StackOneHQ.Client
{
    ...
    public interface IRejectedReasons
    {
        /// <summary>
        /// List Rejected Reasons.
        /// </summary>
        /// <param name="request">A <see cref="AtsListRejectedReasonsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsListRejectedReasonsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsListRejectedReasonsResponse> ListAsync(
        ...
        /// Get Rejected Reason.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetRejectedReasonRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetRejectedReasonResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="request"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="BadRequestResponseException">Invalid request. Thrown when the API returns a 400 response.</exception>
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<AtsGetRejectedReasonResponse> GetAsync(
    ...
    public class RejectedReasons: IRejectedReasons
    {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsListRejectedReasonsResponse> ListAsync(
            AtsListRejectedReasonsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_list_rejected_reasons", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<AtsListRejectedReasonsResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new AtsListRejectedReasonsRequest
                {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<RejectedReasonsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into RejectedReasonsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsListRejectedReasonsResponse()
                    {
                    ...
                    response.RejectedReasonsPaginated = obj;
                    return response;
                }
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetRejectedReasonResponse> GetAsync(
            AtsGetRejectedReasonRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_rejected_reason", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<RejectedReasonResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into RejectedReasonResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsGetRejectedReasonResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.RejectedReasonResult = obj;
                    return response;
                }
