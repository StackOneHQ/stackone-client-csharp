...
namespace StackOneHQ.Client
{
    ...
    public interface IBackgroundChecksPackages
    {
        /// <summary>
        /// Get Background Check Package.
        /// </summary>
        /// <param name="request">A <see cref="AtsGetBackgroundCheckPackageRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AtsGetBackgroundCheckPackageResponse"/> response envelope when completed.</returns>
        ...
        public  Task<AtsGetBackgroundCheckPackageResponse> GetAsync(
            AtsGetBackgroundCheckPackageRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class BackgroundChecksPackages: IBackgroundChecksPackages
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public BackgroundChecksPackages(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AtsGetBackgroundCheckPackageResponse> GetAsync(
            AtsGetBackgroundCheckPackageRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_background_check_package", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<BackgroundCheckPackageResult>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into BackgroundCheckPackageResult.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AtsGetBackgroundCheckPackageResponse()
                    {
                    ...
                    response.BackgroundCheckPackageResult = obj;
                    return response;
                }
