...
namespace StackOneHQ.Client
{
    ...
    public interface IBackgroundChecksPackages
    {
        ...
        /// </summary>
        Task<AtsGetBackgroundCheckPackageResponse> GetAsync(AtsGetBackgroundCheckPackageRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class BackgroundChecksPackages: IBackgroundChecksPackages
    {
        ...
        public async Task<AtsGetBackgroundCheckPackageResponse> GetAsync(AtsGetBackgroundCheckPackageRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ats_get_background_check_package", new List<string> {  }, SDKConfiguration.SecuritySource);
