...
namespace StackOneHQ.Client
{
    ...
    public interface IShifts
    {
        ...
        /// Get Shift
        /// </summary>
        Task<HrisGetShiftResponse> GetAsync(HrisGetShiftRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Shifts: IShifts
    {
        ...
        public async Task<HrisGetShiftResponse> GetAsync(HrisGetShiftRequest request, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/shifts/{id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_shift", new List<string> {  }, SDKConfiguration.SecuritySource);
