...
namespace StackOneHQ.Client
{
    ...
    public interface IShifts
    {
        ...
        /// Get Shift.
        /// </summary>
        /// <param name="request">A <see cref="HrisGetShiftRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="HrisGetShiftResponse"/> response envelope when completed.</returns>
        ...
        public  Task<HrisGetShiftResponse> GetAsync(HrisGetShiftRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class Shifts: IShifts
    {
        ...
        public Shifts(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<HrisGetShiftResponse> GetAsync(HrisGetShiftRequest request, RetryConfig? retryConfig = null)
        {
            if (request == null) throw new ArgumentNullException(nameof(request));

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/unified/hris/shifts/{id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "hris_get_shift", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new HrisGetShiftResponse()
                    {
