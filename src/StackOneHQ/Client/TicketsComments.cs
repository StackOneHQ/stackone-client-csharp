...
namespace StackOneHQ.Client
{
    ...
    public interface ITicketsComments
    {
        ...
        /// </remarks>
        /// </summary>
        Task<TicketingListCommentsResponse> ListAsync(TicketingListCommentsRequest request, RetryConfig? retryConfig = null);
    }
    ...
    public class TicketsComments: ITicketsComments
    {
        ...
        public async Task<TicketingListCommentsResponse> ListAsync(TicketingListCommentsRequest request, RetryConfig? retryConfig = null)
        {
