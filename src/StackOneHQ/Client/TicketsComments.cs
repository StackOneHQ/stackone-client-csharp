...
namespace StackOneHQ.Client
{
    ...
    public interface ITicketsComments
    {
        /// <summary>
        /// List Comments.
        /// </summary>
        ...
        /// </remarks>
        /// <param name="request">A <see cref="TicketingListCommentsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="TicketingListCommentsResponse"/> response envelope when completed.</returns>
        ...
        public  Task<TicketingListCommentsResponse> ListAsync(
            TicketingListCommentsRequest request,
            RetryConfig? retryConfig = null
        );
    }

    public class TicketsComments: ITicketsComments
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public TicketsComments(SDKConfig config)
        {
        ...
        /// <exception cref="BadGatewayResponseException">Bad gateway error. Thrown when the API returns a 502 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<TicketingListCommentsResponse> ListAsync(
            TicketingListCommentsRequest request,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/unified/ticketing/tickets/{id}/comments", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ticketing_list_comments", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<TicketingCommentsPaginated>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into TicketingCommentsPaginated.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
